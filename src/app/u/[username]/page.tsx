    ...
    <main className="emb-page min-h-screen px-4 pb-20 pt-32 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="text-center">
          ...
          <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-embir-rose via-embir-rose-deep to-embir-plum-soft text-3xl font-black text-embir-void">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            {data.isFounder && (
              <span className="rounded-full border border-embir-rose-deep/30 bg-embir-rose-deep/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-embir-rose-soft">
                Founder
              </span>
            )}
          </div>
        ...
        {/* CTA */}
        <div className="mt-12 rounded-2xl border border-embir-rose/20 bg-gradient-to-r from-embir-rose/[0.08] via-embir-rose-deep/[0.04] to-embir-plum-soft/[0.08] p-8 text-center">
