...
export const metadata: Metadata = {
  title: "Application de rencontre sans abonnement — 100% gratuite",
  description: "Embir est 100% gratuit pendant le lancement. Messagerie illimitée, matching IA, zéro pub. Les membres fondateurs gardent l'accès premium à vie.",
  ...
  openGraph: {
    ...
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Application+de+rencontre+sans+abonnement+—+100%+gratuite&variant=market`],
  },
};
      ...
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#d4a574]/20 bg-[#d4a574]/5 px-4 py-1.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[#d4a574]/80">Gratuit</span>
          </div>
          ...
          <p className="mt-6 text-lg leading-relaxed text-white/50">Embir est 100% gratuit pendant le lancement. Messagerie illimitée, matching IA, zéro pub. Les membres fondateurs gardent l'accès premium à vie.</p>
