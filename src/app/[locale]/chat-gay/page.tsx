...
export const metadata: Metadata = {
  title: "Gay Chat — Free messaging between reciprocal connections",
  description: "Free gay chat on Embir. messaging between reciprocal connections, Core connections without a credit card. Talk to guys near you.",
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <p className="text-white/50 text-lg mb-8 leading-relaxed">Free gay chat on Embir. messaging between reciprocal connections, Core connections without a credit card. Talk to guys near you.</p>
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 text-center mb-10">
            ...
            <p className="text-white/50 mb-6">Join Embir now. Core connections are free, messaging between reciprocal connections.</p>
