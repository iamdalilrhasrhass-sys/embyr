...
export const metadata: Metadata = {
  ...
  description: "Embir est une application de rencontre sérieuse conçue pour favoriser les connexions authentiques. Profils vérifiés, matching par compatibilité, sans publicité. Les connexions essentielles sont gratuites.",
alternates: {
