...
export const metadata: Metadata = {
  ...
  description: "Embir est conçu pour la communauté LGBTQ+ qui cherche des relations sérieuses. Les connexions essentielles sont gratuites, profils vérifiés.",
      ...
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-embir-rose/20 bg-embir-rose/5 px-4 py-1.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-embir-rose/80">LGBTQ+</span>
          </div>
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rencontre sérieuse LGBTQ+</h1>
          <p className="mt-6 text-lg text-white/50">Embir est conçu pour la communauté LGBTQ+ qui cherche des relations sérieuses. Les connexions essentielles sont gratuites, profils vérifiés.</p>
