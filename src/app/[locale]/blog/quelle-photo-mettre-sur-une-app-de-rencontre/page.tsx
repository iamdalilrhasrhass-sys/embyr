...
export const metadata: Metadata = {
  title: "Quelle photo mettre sur une application de rencontre",
  description: "Quelle photo mettre sur une application de rencontre",
  alternates: { canonical: "https://embir.xyz/blog/quelle-photo-mettre-sur-une-app-de-rencontre" },
  openGraph: {
    title: "Quelle photo mettre sur une application de rencontre",
    description: "Quelle photo mettre sur une application de rencontre",
    url: "https://embir.xyz/blog/quelle-photo-mettre-sur-une-app-de-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Quelle+photo+mettre+sur+une+application+de+rencontre&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Quelle photo de profil choisir</h1>
          <p className="mt-5 text-lg text-white/45">Quelle photo mettre sur une application de rencontre</p>
        </div>
      </header>
