...
export const metadata: Metadata = {
  title: "Comment faire une rencontre authentique en ligne",
  description: "Comment faire une rencontre authentique en ligne",
  alternates: { canonical: "https://embir.xyz/blog/comment-faire-une-rencontre-authentique" },
  openGraph: {
    title: "Comment faire une rencontre authentique en ligne",
    description: "Comment faire une rencontre authentique en ligne",
    url: "https://embir.xyz/blog/comment-faire-une-rencontre-authentique",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Comment+faire+une+rencontre+authentique+en+ligne&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Comment faire une rencontre authentique</h1>
          <p className="mt-5 text-lg text-white/45">Comment faire une rencontre authentique en ligne</p>
        </div>
      </header>
