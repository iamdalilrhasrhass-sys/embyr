...
export const metadata: Metadata = {
  title: "Après une rupture : comment rebondir et rencontrer à nouveau",
  description: "Après une rupture : comment rebondir et rencontrer à nouveau",
  alternates: { canonical: "https://embir.xyz/blog/rupture-amoureuse-rebondir" },
  openGraph: {
    title: "Après une rupture : comment rebondir et rencontrer à nouveau",
    description: "Après une rupture : comment rebondir et rencontrer à nouveau",
    url: "https://embir.xyz/blog/rupture-amoureuse-rebondir",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Après+une+rupture+:+comment+rebondir+et+rencontrer+à+nouveau&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rebondir après une rupture</h1>
          <p className="mt-5 text-lg text-white/45">Après une rupture : comment rebondir et rencontrer à nouveau</p>
        </div>
      </header>
