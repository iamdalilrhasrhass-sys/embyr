...
export const metadata: Metadata = {
  title: "Grindr est-il encore le meilleur choix en 2026",
  description: "Grindr est-il encore le meilleur choix en 2026",
  alternates: { canonical: "https://embir.xyz/blog/grindr-est-il-encore-le-meilleur-choix" },
  openGraph: {
    title: "Grindr est-il encore le meilleur choix en 2026",
    description: "Grindr est-il encore le meilleur choix en 2026",
    url: "https://embir.xyz/blog/grindr-est-il-encore-le-meilleur-choix",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Grindr+est-il+encore+le+meilleur+choix+en+2026&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Grindr en 2026 : toujours le meilleur ?</h1>
          <p className="mt-5 text-lg text-white/45">Grindr est-il encore le meilleur choix en 2026</p>
        </div>
      </header>
