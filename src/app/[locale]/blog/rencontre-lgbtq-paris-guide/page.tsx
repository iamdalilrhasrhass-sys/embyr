...
export const metadata: Metadata = {
  title: "Rencontre LGBTQ+ à Paris — le guide inclusif 2026",
  description: "Guide des rencontres LGBTQ+ à Paris : lieux, applis, événements, associations. Embir, l'application inclusive et gratuite pour toute la communauté.",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-lgbtq-paris-guide" },
  openGraph: {
    title: "Rencontre LGBTQ+ à Paris — le guide inclusif 2026",
    description: "Guide des rencontres LGBTQ+ à Paris : lieux, applis, événements, associations. Embir, l'application inclusive et gratuite pour toute la communauté.",
    url: "https://embir.xyz/blog/rencontre-lgbtq-paris-guide",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+LGBTQ++à+Paris+—+le+guide+inclusif+2026&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Rencontre LGBTQ+ à Paris : un guide inclusif pour toutes les communautés</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Guide des rencontres LGBTQ+ à Paris : lieux, applis, événements, associations. Embir, l'application inclusive et gratuite pour toute la communauté.</p>
