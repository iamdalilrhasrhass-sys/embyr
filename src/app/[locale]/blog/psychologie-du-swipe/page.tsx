...
export const metadata: Metadata = {
  title: "La psychologie du swipe : pourquoi on devient accro",
  description: "La psychologie du swipe : pourquoi on devient accro",
  alternates: { canonical: "https://embir.xyz/blog/psychologie-du-swipe" },
  openGraph: {
    title: "La psychologie du swipe : pourquoi on devient accro",
    description: "La psychologie du swipe : pourquoi on devient accro",
    url: "https://embir.xyz/blog/psychologie-du-swipe",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=La+psychologie+du+swipe+:+pourquoi+on+devient+accro&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">La psychologie du swipe décryptée</h1>
          <p className="mt-5 text-lg text-white/45">La psychologie du swipe : pourquoi on devient accro</p>
        </div>
      </header>
