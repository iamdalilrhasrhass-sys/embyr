...
export const metadata: Metadata = {
  title: "Les meilleurs quartiers gay-friendly dans les grandes villes de France | Embyr Blog",
  ...
  keywords: ["meilleurs quartiers gay villes france", "gay", "LGBTQ+", "rencontre gay", "Embyr"],
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-black mb-6 text-white">Les meilleurs quartiers gay-friendly dans les grandes villes de France</h1>
          
          <div className="prose prose-invert max-w-none text-white/50 space-y-4 leading-relaxed">
            <p>Guide des quartiers gay-friendly à Paris, Lyon, Marseille, Bordeaux, Toulouse, Lille, Nantes, Strasbourg, Montpellier et Nice.</p>
