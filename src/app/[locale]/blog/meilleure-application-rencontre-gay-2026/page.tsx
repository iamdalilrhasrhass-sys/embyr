...
export const metadata: Metadata = {
  title: "Meilleure application de rencontre gay 2026 — comparatif et avis",
  description: "Comparatif complet des applications de rencontre gay : Grindr, Scruff, Romeo, Hornet et Embir. Prix, sécurité, fonctionnalités gratuites.",
  alternates: { canonical: "https://embir.xyz/blog/meilleure-application-rencontre-gay-2026" },
  openGraph: {
    title: "Meilleure application de rencontre gay 2026 — comparatif et avis",
    description: "Comparatif complet des applications de rencontre gay : Grindr, Scruff, Romeo, Hornet et Embir. Prix, sécurité, fonctionnalités gratuites.",
    url: "https://embir.xyz/blog/meilleure-application-rencontre-gay-2026",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Meilleure+application+de+rencontre+gay+2026+—+comparatif+et+avis&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Quelle est la meilleure application de rencontre gay en 2026 ?</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            Comparatif complet des applications de rencontre gay : Grindr, Scruff, Romeo, Hornet et Embir. Prix, sécurité, fonctionnalités gratuites.
          </p>
