...
export const metadata: Metadata = {
  title: "Top 15 des villes LGBTQ+ friendly en France",
  description: "Top 15 des villes LGBTQ+ friendly en France",
  alternates: { canonical: "https://embir.xyz/blog/lgbtq-friendly-villes-france" },
  openGraph: {
    title: "Top 15 des villes LGBTQ+ friendly en France",
    description: "Top 15 des villes LGBTQ+ friendly en France",
    url: "https://embir.xyz/blog/lgbtq-friendly-villes-france",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
  },
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Les villes les plus LGBTQ+ friendly de France</h1>
          <p className="mt-5 text-lg text-white/45">Top 15 des villes LGBTQ+ friendly en France</p>
        </div>
      </header>
