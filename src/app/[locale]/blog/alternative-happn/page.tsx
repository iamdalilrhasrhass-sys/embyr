...
export const metadata: Metadata = {
  title: "Alternative à Happn : les meilleures options",
  description: "Alternative à Happn : les meilleures options",
  alternates: { canonical: "https://embir.xyz/blog/alternative-happn" },
  openGraph: {
    title: "Alternative à Happn : les meilleures options",
    description: "Alternative à Happn : les meilleures options",
    url: "https://embir.xyz/blog/alternative-happn",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Alternative+à+Happn+:+les+meilleures+options&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Les meilleures alternatives à Happn</h1>
          <p className="mt-5 text-lg text-white/45">Alternative à Happn : les meilleures options</p>
        </div>
      </header>
