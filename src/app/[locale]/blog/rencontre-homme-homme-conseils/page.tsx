...
export const metadata: Metadata = {
  title: "Rencontre homme-homme : guide complet 2026",
  description: "Rencontre homme-homme : guide complet 2026",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-homme-homme-conseils" },
  openGraph: {
    title: "Rencontre homme-homme : guide complet 2026",
    description: "Rencontre homme-homme : guide complet 2026",
    url: "https://embir.xyz/blog/rencontre-homme-homme-conseils",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+homme-homme+:+guide+complet+2026&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rencontre entre hommes : guide complet</h1>
          <p className="mt-5 text-lg text-white/45">Rencontre homme-homme : guide complet 2026</p>
        </div>
      </header>
