...
export const metadata: Metadata = {
  title: "Gay dating Lyon : bars, quartiers et applis",
  description: "Gay dating Lyon : bars, quartiers et applis",
  alternates: { canonical: "https://embir.xyz/blog/gay-dating-lyon-guide" },
  openGraph: {
    title: "Gay dating Lyon : bars, quartiers et applis",
    description: "Gay dating Lyon : bars, quartiers et applis",
    url: "https://embir.xyz/blog/gay-dating-lyon-guide",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Gay+dating+Lyon+:+bars,+quartiers+et+applis&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Gay dating à Lyon : le guide complet</h1>
          <p className="mt-5 text-lg text-white/45">Gay dating Lyon : bars, quartiers et applis</p>
        </div>
      </header>
