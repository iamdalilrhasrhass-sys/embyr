...
export const metadata: Metadata = {
  title: "Application de rencontre sans publicité — est-ce possible ?",
  description: "La plupart des applis de rencontre sont truffées de pubs. Découvrez les alternatives sans publicité et l'expérience premium gratuite d'Embir.",
  alternates: { canonical: "https://embir.xyz/blog/application-rencontre-sans-pub-guide" },
  openGraph: {
    title: "Application de rencontre sans publicité — est-ce possible ?",
    description: "La plupart des applis de rencontre sont truffées de pubs. Découvrez les alternatives sans publicité et l'expérience premium gratuite d'Embir.",
    url: "https://embir.xyz/blog/application-rencontre-sans-pub-guide",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Application+de+rencontre+sans+publicité+—+est-ce+possible+?&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Existe-t-il des applications de rencontre sans publicité ?</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            La plupart des applis de rencontre sont truffées de pubs. Découvrez les alternatives sans publicité et l'expérience premium gratuite d'Embir.
          </p>
