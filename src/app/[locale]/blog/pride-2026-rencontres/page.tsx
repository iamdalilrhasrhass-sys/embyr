...
export const metadata: Metadata = {
  title: "Pride 2026 : comment les célébrations influencent les rencontres",
  description: "Pride 2026 : comment les célébrations influencent les rencontres",
  alternates: { canonical: "https://embir.xyz/blog/pride-2026-rencontres" },
  openGraph: {
    title: "Pride 2026 : comment les célébrations influencent les rencontres",
    description: "Pride 2026 : comment les célébrations influencent les rencontres",
    url: "https://embir.xyz/blog/pride-2026-rencontres",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Pride+2026+:+comment+les+célébrations+influencent+les+rencontres&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Pride 2026 et rencontres : ce qu'il faut savoir</h1>
          <p className="mt-5 text-lg text-white/45">Pride 2026 : comment les célébrations influencent les rencontres</p>
        </div>
      </header>
