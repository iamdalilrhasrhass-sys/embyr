...
export const metadata: Metadata = {
  title: "Pourquoi les applications de rencontre fatiguent — et comment retrouver du plaisir",
  description: "Le 'dating fatigue' est réel : swipe infini, conversations fantômes, profils douteux. Découvrez pourquoi et comment retrouver une expérience saine.",
  alternates: { canonical: "https://embir.xyz/blog/pourquoi-les-applis-de-rencontre-fatiguent" },
  openGraph: {
    title: "Pourquoi les applications de rencontre fatiguent — et comment retrouver du plaisir",
    description: "Le 'dating fatigue' est réel : swipe infini, conversations fantômes, profils douteux. Découvrez pourquoi et comment retrouver une expérience saine.",
    url: "https://embir.xyz/blog/pourquoi-les-applis-de-rencontre-fatiguent",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Pourquoi+les+applications+de+rencontre+fatiguent+—+et+comment+retrouver+du+plaisir&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Pourquoi les applications de rencontre fatiguent (et ce qu'on peut y faire)</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            Le 'dating fatigue' est réel : swipe infini, conversations fantômes, profils douteux. Découvrez pourquoi et comment retrouver une expérience saine.
          </p>
