...
export const metadata: Metadata = {
  title: "Comment savoir si un profil est sérieux sur une appli de rencontre",
  description: "Comment savoir si un profil est sérieux sur une appli de rencontre",
  alternates: { canonical: "https://embir.xyz/blog/comment-savoir-si-un-profil-est-serieux" },
  openGraph: {
    title: "Comment savoir si un profil est sérieux sur une appli de rencontre",
    description: "Comment savoir si un profil est sérieux sur une appli de rencontre",
    url: "https://embir.xyz/blog/comment-savoir-si-un-profil-est-serieux",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Comment+savoir+si+un+profil+est+sérieux+sur+une+appli+de+rencontre&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Comment savoir si un profil est sérieux</h1>
          <p className="mt-5 text-lg text-white/45">Comment savoir si un profil est sérieux sur une appli de rencontre</p>
        </div>
      </header>
