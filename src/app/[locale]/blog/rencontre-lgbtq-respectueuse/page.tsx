...
export const metadata: Metadata = {
  title: "Rencontre LGBTQ+ respectueuse : guide complet",
  description: "Rencontre LGBTQ+ respectueuse : guide complet",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-lgbtq-respectueuse" },
  openGraph: {
    title: "Rencontre LGBTQ+ respectueuse : guide complet",
    description: "Rencontre LGBTQ+ respectueuse : guide complet",
    url: "https://embir.xyz/blog/rencontre-lgbtq-respectueuse",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+LGBTQ++respectueuse+:+guide+complet&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rencontre LGBTQ+ respectueuse : le guide</h1>
          <p className="mt-5 text-lg text-white/45">Rencontre LGBTQ+ respectueuse : guide complet</p>
        </div>
      </header>
