...
export const metadata: Metadata = {
  title: "Peur du rejet dans les rencontres : comment la surmonter",
  description: "Peur du rejet dans les rencontres : comment la surmonter",
  alternates: { canonical: "https://embir.xyz/blog/peur-du-rejet-rencontres" },
  openGraph: {
    title: "Peur du rejet dans les rencontres : comment la surmonter",
    description: "Peur du rejet dans les rencontres : comment la surmonter",
    url: "https://embir.xyz/blog/peur-du-rejet-rencontres",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
  },
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Surmonter la peur du rejet</h1>
          <p className="mt-5 text-lg text-white/45">Peur du rejet dans les rencontres : comment la surmonter</p>
        </div>
      </header>
