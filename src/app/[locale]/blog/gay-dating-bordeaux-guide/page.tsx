...
export const metadata: Metadata = {
  title: "Gay dating Bordeaux : guide des meilleures adresses",
  description: "Gay dating Bordeaux : guide des meilleures adresses",
  alternates: { canonical: "https://embir.xyz/blog/gay-dating-bordeaux-guide" },
  openGraph: {
    title: "Gay dating Bordeaux : guide des meilleures adresses",
    description: "Gay dating Bordeaux : guide des meilleures adresses",
    url: "https://embir.xyz/blog/gay-dating-bordeaux-guide",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Gay+dating+Bordeaux+:+guide+des+meilleures+adresses&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Gay dating à Bordeaux : bars, quartiers, applis</h1>
          <p className="mt-5 text-lg text-white/45">Gay dating Bordeaux : guide des meilleures adresses</p>
        </div>
      </header>
