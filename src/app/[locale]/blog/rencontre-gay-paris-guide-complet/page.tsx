...
export const metadata: Metadata = {
  title: "Rencontre gay à Paris — guide complet 2026",
  description: "Guide complet des rencontres gays à Paris : applis, bars, quartiers, conseils. Découvrez Embir, l'alternative gratuite et sans pub pour rencontrer des hommes à Paris.",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-gay-paris-guide-complet" },
  openGraph: {
    title: "Rencontre gay à Paris — guide complet 2026",
    description: "Guide complet des rencontres gays à Paris : applis, bars, quartiers, conseils. Découvrez Embir, l'alternative gratuite et sans pub pour rencontrer des hommes à Paris.",
    url: "https://embir.xyz/blog/rencontre-gay-paris-guide-complet",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+gay+à+Paris+—+guide+complet+2026&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Rencontre gay à Paris : le guide complet pour faire des vraies rencontres</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Guide complet des rencontres gays à Paris : applis, bars, quartiers, conseils. Découvrez Embir, l'alternative gratuite et sans pub pour rencontrer des hommes à Paris.</p>
