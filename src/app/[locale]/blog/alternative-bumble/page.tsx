...
export const metadata: Metadata = {
  title: "Alternative à Bumble : comparatif des meilleures options",
  description: "Alternative à Bumble : comparatif des meilleures options",
  alternates: { canonical: "https://embir.xyz/blog/alternative-bumble" },
  openGraph: {
    title: "Alternative à Bumble : comparatif des meilleures options",
    description: "Alternative à Bumble : comparatif des meilleures options",
    url: "https://embir.xyz/blog/alternative-bumble",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Alternative+à+Bumble+:+comparatif+des+meilleures+options&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Les meilleures alternatives à Bumble</h1>
          <p className="mt-5 text-lg text-white/45">Alternative à Bumble : comparatif des meilleures options</p>
        </div>
      </header>
