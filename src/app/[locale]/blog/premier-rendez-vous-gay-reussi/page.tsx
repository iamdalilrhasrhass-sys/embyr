...
export const metadata: Metadata = {
  title: "Premier rendez-vous gay réussi — 10 conseils pour impressionner | Embyr Blog",
  ...
  keywords: ["premier rendez vous gay reussi", "gay", "LGBTQ+", "rencontre gay", "Embyr"],
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-black mb-6 text-white">Premier rendez-vous gay réussi — 10 conseils pour impressionner</h1>
          
          <div className="prose prose-invert max-w-none text-white/50 space-y-4 leading-relaxed">
            <p>Tout pour réussir ton premier rendez-vous gay. Du choix du lieu à la conversation, en passant par les gestes qui font la différence.</p>
