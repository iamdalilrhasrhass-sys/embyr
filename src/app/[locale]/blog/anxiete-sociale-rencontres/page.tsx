...
export const metadata: Metadata = {
  title: "Anxiété sociale et rencontres en ligne : comment gérer",
  description: "Anxiété sociale et rencontres en ligne : comment gérer",
  alternates: { canonical: "https://embir.xyz/blog/anxiete-sociale-rencontres" },
  openGraph: {
    title: "Anxiété sociale et rencontres en ligne : comment gérer",
    description: "Anxiété sociale et rencontres en ligne : comment gérer",
    url: "https://embir.xyz/blog/anxiete-sociale-rencontres",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Anxiété+sociale+et+rencontres+en+ligne+:+comment+gérer&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Anxiété sociale et rencontres</h1>
          <p className="mt-5 text-lg text-white/45">Anxiété sociale et rencontres en ligne : comment gérer</p>
        </div>
      </header>
