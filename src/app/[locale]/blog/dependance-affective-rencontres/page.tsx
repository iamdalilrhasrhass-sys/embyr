...
export const metadata: Metadata = {
  title: "Dépendance affective et rencontres : briser le cycle",
  description: "Dépendance affective et rencontres : briser le cycle",
  alternates: { canonical: "https://embir.xyz/blog/dependance-affective-rencontres" },
  openGraph: {
    title: "Dépendance affective et rencontres : briser le cycle",
    description: "Dépendance affective et rencontres : briser le cycle",
    url: "https://embir.xyz/blog/dependance-affective-rencontres",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Dépendance+affective+et+rencontres+:+briser+le+cycle&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Dépendance affective : en sortir</h1>
          <p className="mt-5 text-lg text-white/45">Dépendance affective et rencontres : briser le cycle</p>
        </div>
      </header>
