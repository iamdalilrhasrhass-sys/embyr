...
export const metadata: Metadata = {
  ...
  description: "Analyse du modèle économique des applis de rencontre. Pourquoi Embir fait le choix radical de la gratuité des connexions essentielles.",
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-white/45">Analyse du modèle économique des applis de rencontre. Pourquoi Embir fait le choix radical de la gratuité des connexions essentielles.</p>
