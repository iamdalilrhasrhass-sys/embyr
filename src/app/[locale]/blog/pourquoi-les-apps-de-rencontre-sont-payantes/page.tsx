...
export const metadata: Metadata = {
  title: "Pourquoi les applis de rencontre sont payantes — et l'exception Embir",
  description: "Analyse du modèle économique des applis de rencontre. Pourquoi Embir fait le choix radical de la gratuité au lancement.",
  alternates: { canonical: "https://embir.xyz/blog/pourquoi-les-apps-de-rencontre-sont-payantes" },
  openGraph: {
    title: "Pourquoi les applis de rencontre sont payantes — et l'exception Embir",
    description: "Analyse du modèle économique des applis de rencontre. Pourquoi Embir fait le choix radical de la gratuité au lancement.",
    url: "https://embir.xyz/blog/pourquoi-les-apps-de-rencontre-sont-payantes",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Pourquoi+les+applis+de+rencontre+sont+payantes+—+et+l&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Pourquoi les applis de rencontre sont-elles toutes devenues payantes ?</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Analyse du modèle économique des applis de rencontre. Pourquoi Embir fait le choix radical de la gratuité au lancement.</p>
