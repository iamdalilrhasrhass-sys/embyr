...
export const metadata: Metadata = {
  title: "Rencontre gay sérieuse — trouver une relation durable",
  description: "Guide pour les hommes gays qui cherchent une relation sérieuse. Conseils, pièges à éviter, et comment Embir favorise les connexions authentiques.",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-gay-serieuse-relation-durable" },
  openGraph: {
    title: "Rencontre gay sérieuse — trouver une relation durable",
    description: "Guide pour les hommes gays qui cherchent une relation sérieuse. Conseils, pièges à éviter, et comment Embir favorise les connexions authentiques.",
    url: "https://embir.xyz/blog/rencontre-gay-serieuse-relation-durable",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+gay+sérieuse+—+trouver+une+relation+durable&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Comment trouver une relation gay sérieuse et durable en 2026</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Guide pour les hommes gays qui cherchent une relation sérieuse. Conseils, pièges à éviter, et comment Embir favorise les connexions authentiques.</p>
