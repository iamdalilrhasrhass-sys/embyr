...
export const metadata: Metadata = {
  title: "Applications de rencontre 2026 — tendances et nouveautés",
  description: "Quoi de neuf dans les applis de rencontre en 2026 ? IA, vérification, matching intelligent, gratuité. Découvrez les tendances qui changent le dating.",
  alternates: { canonical: "https://embir.xyz/blog/application-rencontre-2026-tendances" },
  openGraph: {
    title: "Applications de rencontre 2026 — tendances et nouveautés",
    description: "Quoi de neuf dans les applis de rencontre en 2026 ? IA, vérification, matching intelligent, gratuité. Découvrez les tendances qui changent le dating.",
    url: "https://embir.xyz/blog/application-rencontre-2026-tendances",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Applications+de+rencontre+2026+—+tendances+et+nouveautés&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Les tendances des applications de rencontre en 2026</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Quoi de neuf dans les applis de rencontre en 2026 ? IA, vérification, matching intelligent, gratuité. Découvrez les tendances qui changent le dating.</p>
