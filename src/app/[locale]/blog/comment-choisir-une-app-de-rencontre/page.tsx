...
export const metadata: Metadata = {
  title: "Comment choisir une application de rencontre en 2026",
  description: "Comment choisir une application de rencontre en 2026",
  alternates: { canonical: "https://embir.xyz/blog/comment-choisir-une-app-de-rencontre" },
  openGraph: {
    title: "Comment choisir une application de rencontre en 2026",
    description: "Comment choisir une application de rencontre en 2026",
    url: "https://embir.xyz/blog/comment-choisir-une-app-de-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Comment+choisir+une+application+de+rencontre+en+2026&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Comment choisir une application de rencontre</h1>
          <p className="mt-5 text-lg text-white/45">Comment choisir une application de rencontre en 2026</p>
        </div>
      </header>
