...
export const metadata: Metadata = {
  title: "Stalking et cyberharcèlement après un date : que faire",
  description: "Stalking et cyberharcèlement après un date : que faire",
  alternates: { canonical: "https://embir.xyz/blog/stalking-cyberharcelement-rencontre" },
  openGraph: {
    title: "Stalking et cyberharcèlement après un date : que faire",
    description: "Stalking et cyberharcèlement après un date : que faire",
    url: "https://embir.xyz/blog/stalking-cyberharcelement-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Stalking+et+cyberharcèlement+après+un+date+:+que+faire&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Stalking après un date : comment réagir</h1>
          <p className="mt-5 text-lg text-white/45">Stalking et cyberharcèlement après un date : que faire</p>
        </div>
      </header>
