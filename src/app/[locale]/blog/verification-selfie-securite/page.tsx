...
export const metadata: Metadata = {
  title: "Vérification par selfie : la meilleure protection",
  description: "Vérification par selfie : la meilleure protection",
  alternates: { canonical: "https://embir.xyz/blog/verification-selfie-securite" },
  openGraph: {
    title: "Vérification par selfie : la meilleure protection",
    description: "Vérification par selfie : la meilleure protection",
    url: "https://embir.xyz/blog/verification-selfie-securite",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
  },
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">La vérification selfie protège vos rencontres</h1>
          <p className="mt-5 text-lg text-white/45">Vérification par selfie : la meilleure protection</p>
        </div>
      </header>
