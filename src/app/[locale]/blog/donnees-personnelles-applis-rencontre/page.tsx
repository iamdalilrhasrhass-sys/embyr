...
export const metadata: Metadata = {
  title: "Données personnelles sur les applis : comment les protéger",
  description: "Données personnelles sur les applis : comment les protéger",
  alternates: { canonical: "https://embir.xyz/blog/donnees-personnelles-applis-rencontre" },
  openGraph: {
    title: "Données personnelles sur les applis : comment les protéger",
    description: "Données personnelles sur les applis : comment les protéger",
    url: "https://embir.xyz/blog/donnees-personnelles-applis-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Protégez vos données personnelles</h1>
          <p className="mt-5 text-lg text-white/45">Données personnelles sur les applis : comment les protéger</p>
        </div>
      </header>
