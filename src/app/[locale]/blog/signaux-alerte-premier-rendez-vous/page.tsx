...
export const metadata: Metadata = {
  title: "Signaux d'alerte avant un premier rendez-vous",
  description: "Signaux d'alerte avant un premier rendez-vous",
  alternates: { canonical: "https://embir.xyz/blog/signaux-alerte-premier-rendez-vous" },
  openGraph: {
    title: "Signaux d'alerte avant un premier rendez-vous",
    description: "Signaux d'alerte avant un premier rendez-vous",
    url: "https://embir.xyz/blog/signaux-alerte-premier-rendez-vous",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Signaux+d&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Les signaux d'alerte à ne jamais ignorer</h1>
          <p className="mt-5 text-lg text-white/45">Signaux d'alerte avant un premier rendez-vous</p>
        </div>
      </header>
