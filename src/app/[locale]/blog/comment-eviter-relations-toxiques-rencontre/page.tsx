...
export const metadata: Metadata = {
  title: "Comment éviter les relations toxiques sur les applis de rencontre",
  description: "Guide pour identifier les signaux d'alerte sur les applis de rencontre : love bombing, ghosting, manipulation. Protégez-vous avec Embir.",
  alternates: { canonical: "https://embir.xyz/blog/comment-eviter-relations-toxiques-rencontre" },
  openGraph: {
    title: "Comment éviter les relations toxiques sur les applis de rencontre",
    description: "Guide pour identifier les signaux d'alerte sur les applis de rencontre : love bombing, ghosting, manipulation. Protégez-vous avec Embir.",
    url: "https://embir.xyz/blog/comment-eviter-relations-toxiques-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Comment+éviter+les+relations+toxiques+sur+les+applis+de+rencontre&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Comment reconnaître et éviter les relations toxiques dès le premier contact</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Guide pour identifier les signaux d'alerte sur les applis de rencontre : love bombing, ghosting, manipulation. Protégez-vous avec Embir.</p>
      ...
      <section className="px-4 py-12 sm:px-6 lg:px-8 bg-white/[0.01]">
        <div className="mx-auto max-w-3xl prose prose-invert prose-sm text-white/45 leading-relaxed
          ...
          <p>
            ...
            Messagerie illimitée, matching par intelligence artificielle, profils vérifiés, zéro 
            publicité. Les membres fondateurs conservent cet accès premium à vie.
          </p>
          ...
          <p>
            Oui. Pendant la phase de lancement, toutes les fonctionnalités sont gratuites — messagerie, 
            matching, profils. Les membres fondateurs conservent l'accès premium à vie.
          </p>
          ...
          <p>
            Embir est disponible partout en France, avec des communautés actives dans les grandes villes 
