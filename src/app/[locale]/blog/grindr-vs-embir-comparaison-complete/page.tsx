...
export const metadata: Metadata = {
  ...
  description: "Comparaison exhaustive entre Grindr et Embir : prix, pubs, sécurité, vérification, compatibilité réciproque, gratuité. Pourquoi de plus en plus d'hommes choisissent Embir.",
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-white/45">Comparaison exhaustive entre Grindr et Embir : prix, pubs, sécurité, vérification, compatibilité réciproque, gratuité. Pourquoi de plus en plus d'hommes choisissent Embir.</p>
