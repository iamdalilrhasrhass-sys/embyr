...
export const metadata: Metadata = {
  title: "Grindr vs Embir — la comparaison complète et honnête",
  description: "Comparaison exhaustive entre Grindr et Embir : prix, pubs, sécurité, vérification, matching IA, gratuité. Pourquoi de plus en plus d'hommes choisissent Embir.",
  alternates: { canonical: "https://embir.xyz/blog/grindr-vs-embir-comparaison-complete" },
  openGraph: {
    title: "Grindr vs Embir — la comparaison complète et honnête",
    description: "Comparaison exhaustive entre Grindr et Embir : prix, pubs, sécurité, vérification, matching IA, gratuité. Pourquoi de plus en plus d'hommes choisissent Embir.",
    url: "https://embir.xyz/blog/grindr-vs-embir-comparaison-complete",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
  },
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Grindr vs Embir : tout ce qui les différencie</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Comparaison exhaustive entre Grindr et Embir : prix, pubs, sécurité, vérification, matching IA, gratuité. Pourquoi de plus en plus d'hommes choisissent Embir.</p>
