...
export const metadata: Metadata = {
  title: "Rencontre gay sérieuse : 15 conseils pour une relation durable",
  description: "Rencontre gay sérieuse : 15 conseils pour une relation durable",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-gay-serieuse-conseils" },
  openGraph: {
    title: "Rencontre gay sérieuse : 15 conseils pour une relation durable",
    description: "Rencontre gay sérieuse : 15 conseils pour une relation durable",
    url: "https://embir.xyz/blog/rencontre-gay-serieuse-conseils",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rencontre gay sérieuse : le guide complet</h1>
          <p className="mt-5 text-lg text-white/45">Rencontre gay sérieuse : 15 conseils pour une relation durable</p>
        </div>
      </header>
