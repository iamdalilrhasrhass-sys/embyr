...
export const metadata: Metadata = {
  title: "Arnaques amoureuses sur les applis : les reconnaître et les éviter",
  description: "Arnaques amoureuses sur les applis : les reconnaître et les éviter",
  alternates: { canonical: "https://embir.xyz/blog/arnaques-amoureuses-applis-rencontre" },
  openGraph: {
    title: "Arnaques amoureuses sur les applis : les reconnaître et les éviter",
    description: "Arnaques amoureuses sur les applis : les reconnaître et les éviter",
    url: "https://embir.xyz/blog/arnaques-amoureuses-applis-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Arnaques+amoureuses+sur+les+applis+:+les+reconnaître+et+les+éviter&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Arnaques amoureuses : comment les éviter</h1>
          <p className="mt-5 text-lg text-white/45">Arnaques amoureuses sur les applis : les reconnaître et les éviter</p>
        </div>
      </header>
