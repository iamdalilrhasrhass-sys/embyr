...
export const metadata: Metadata = {
  title: "Comment reconnaître un faux profil sur une application de rencontre",
  description: "Guide pratique pour repérer les faux profils : photos volées, messages suspects, demandes d'argent. Protégez-vous avec Embir, où La vérification selfie est disponible et les profils approuvés affichent un badge.",
  alternates: { canonical: "https://embir.xyz/blog/comment-reconnaitre-faux-profil-rencontre" },
  openGraph: {
    title: "Comment reconnaître un faux profil sur une application de rencontre",
    description: "Guide pratique pour repérer les faux profils : photos volées, messages suspects, demandes d'argent. Protégez-vous avec Embir, où La vérification selfie est disponible et les profils approuvés affichent un badge.",
    url: "https://embir.xyz/blog/comment-reconnaitre-faux-profil-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Comment+reconnaître+un+faux+profil+sur+une+application+de+rencontre&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Comment reconnaître un faux profil sur une application de rencontre</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            Guide pratique pour repérer les faux profils : photos volées, messages suspects, demandes d'argent. Protégez-vous avec Embir, où La vérification selfie est disponible et les profils approuvés affichent un badge.
          </p>
