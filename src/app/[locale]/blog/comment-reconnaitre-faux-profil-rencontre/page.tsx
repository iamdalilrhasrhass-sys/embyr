...
export const metadata: Metadata = {
  ...
  description: "Guide pratique pour repérer les faux profils : photos volées, messages suspects, demandes d'argent. Protégez-vous avec Embir, où chaque profil est vérifié.",
      ...
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            Guide pratique pour repérer les faux profils : photos volées, messages suspects, demandes d'argent. Protégez-vous avec Embir, où chaque profil est vérifié.
          </p>
