...
export const metadata: Metadata = {
  title: "Confiance en soi et rencontres : 12 exercices pratiques",
  description: "Confiance en soi et rencontres : 12 exercices pratiques",
  alternates: { canonical: "https://embir.xyz/blog/confiance-en-soi-rencontres" },
  openGraph: {
    title: "Confiance en soi et rencontres : 12 exercices pratiques",
    description: "Confiance en soi et rencontres : 12 exercices pratiques",
    url: "https://embir.xyz/blog/confiance-en-soi-rencontres",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Confiance+en+soi+et+rencontres+:+12+exercices+pratiques&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Boostez votre confiance en vous</h1>
          <p className="mt-5 text-lg text-white/45">Confiance en soi et rencontres : 12 exercices pratiques</p>
        </div>
      </header>
