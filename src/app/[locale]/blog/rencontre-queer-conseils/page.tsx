...
export const metadata: Metadata = {
  title: "Rencontre queer : guide pour une expérience inclusive",
  description: "Rencontre queer : guide pour une expérience inclusive",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-queer-conseils" },
  openGraph: {
    title: "Rencontre queer : guide pour une expérience inclusive",
    description: "Rencontre queer : guide pour une expérience inclusive",
    url: "https://embir.xyz/blog/rencontre-queer-conseils",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+queer+:+guide+pour+une+expérience+inclusive&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rencontre queer : guide complet</h1>
          <p className="mt-5 text-lg text-white/45">Rencontre queer : guide pour une expérience inclusive</p>
        </div>
      </header>
