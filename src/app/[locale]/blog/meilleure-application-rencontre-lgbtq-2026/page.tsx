...
export const metadata: Metadata = {
  title: "Meilleure application de rencontre LGBTQ+ 2026 — guide",
  description: "Guide des applications de rencontre LGBTQ+ : gay, lesbienne, bi, trans, queer. Comparatif, sécurité, inclusivité. Découvrez Embir.",
  alternates: { canonical: "https://embir.xyz/blog/meilleure-application-rencontre-lgbtq-2026" },
  openGraph: {
    title: "Meilleure application de rencontre LGBTQ+ 2026 — guide",
    description: "Guide des applications de rencontre LGBTQ+ : gay, lesbienne, bi, trans, queer. Comparatif, sécurité, inclusivité. Découvrez Embir.",
    url: "https://embir.xyz/blog/meilleure-application-rencontre-lgbtq-2026",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Meilleure+application+de+rencontre+LGBTQ++2026+—+guide&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Quelle est la meilleure application de rencontre LGBTQ+ en 2026 ?</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            Guide des applications de rencontre LGBTQ+ : gay, lesbienne, bi, trans, queer. Comparatif, sécurité, inclusivité. Découvrez Embir.
          </p>
