...
export const metadata: Metadata = {
  title: "Ghosting : pourquoi ça arrive et comment réagir",
  description: "Ghosting : pourquoi ça arrive et comment réagir",
  alternates: { canonical: "https://embir.xyz/blog/ghosting-pourquoi-et-comment" },
  openGraph: {
    title: "Ghosting : pourquoi ça arrive et comment réagir",
    description: "Ghosting : pourquoi ça arrive et comment réagir",
    url: "https://embir.xyz/blog/ghosting-pourquoi-et-comment",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Ghosting+:+pourquoi+ça+arrive+et+comment+réagir&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Ghosting : comprendre et rebondir</h1>
          <p className="mt-5 text-lg text-white/45">Ghosting : pourquoi ça arrive et comment réagir</p>
        </div>
      </header>
