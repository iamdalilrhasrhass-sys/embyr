...
export const metadata: Metadata = {
  title: "Rencontre queer — espaces inclusifs et bienveillants",
  description: "Guide pour la communauté queer sur les applis de rencontre. Inclusivité, diversité de genre, respect des identités. Embir, une appli pour tous·tes.",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-queer-espaces-inclusifs" },
  openGraph: {
    title: "Rencontre queer — espaces inclusifs et bienveillants",
    description: "Guide pour la communauté queer sur les applis de rencontre. Inclusivité, diversité de genre, respect des identités. Embir, une appli pour tous·tes.",
    url: "https://embir.xyz/blog/rencontre-queer-espaces-inclusifs",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+queer+—+espaces+inclusifs+et+bienveillants&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Rencontre queer : trouver son espace dans le dating en ligne</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Guide pour la communauté queer sur les applis de rencontre. Inclusivité, diversité de genre, respect des identités. Embir, une appli pour tous·tes.</p>
