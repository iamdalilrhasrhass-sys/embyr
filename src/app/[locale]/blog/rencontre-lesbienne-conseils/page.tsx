...
export const metadata: Metadata = {
  title: "Rencontre lesbienne : guide, applis et conseils",
  description: "Rencontre lesbienne : guide, applis et conseils",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-lesbienne-conseils" },
  openGraph: {
    title: "Rencontre lesbienne : guide, applis et conseils",
    description: "Rencontre lesbienne : guide, applis et conseils",
    url: "https://embir.xyz/blog/rencontre-lesbienne-conseils",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+lesbienne+:+guide,+applis+et+conseils&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rencontre lesbienne : le guide complet</h1>
          <p className="mt-5 text-lg text-white/45">Rencontre lesbienne : guide, applis et conseils</p>
        </div>
      </header>
