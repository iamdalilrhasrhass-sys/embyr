...
export const metadata: Metadata = {
  title: "Rencontre gay après 40 ans : guide et conseils",
  description: "Rencontre gay après 40 ans : guide et conseils",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-gay-apres-40-ans" },
  openGraph: {
    title: "Rencontre gay après 40 ans : guide et conseils",
    description: "Rencontre gay après 40 ans : guide et conseils",
    url: "https://embir.xyz/blog/rencontre-gay-apres-40-ans",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+gay+après+40+ans+:+guide+et+conseils&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rencontre gay après 40 ans</h1>
          <p className="mt-5 text-lg text-white/45">Rencontre gay après 40 ans : guide et conseils</p>
        </div>
      </header>
