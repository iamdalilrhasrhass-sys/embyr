...
export const metadata: Metadata = {
  title: "Gay dating Paris : le guide des meilleures adresses",
  description: "Gay dating Paris : le guide des meilleures adresses",
  alternates: { canonical: "https://embir.xyz/blog/gay-dating-paris-guide" },
  openGraph: {
    title: "Gay dating Paris : le guide des meilleures adresses",
    description: "Gay dating Paris : le guide des meilleures adresses",
    url: "https://embir.xyz/blog/gay-dating-paris-guide",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-5 text-lg text-white/45">Gay dating Paris : le guide des meilleures adresses</p>
        </div>
      </header>
