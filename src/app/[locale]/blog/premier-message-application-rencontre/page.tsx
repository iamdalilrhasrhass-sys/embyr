...
export const metadata: Metadata = {
  title: "Premier message sur une application de rencontre — exemples qui marchent",
  description: "Des exemples concrets de premiers messages qui obtiennent des réponses. Ce qu'il faut dire (et ne pas dire) pour engager la conversation.",
  alternates: { canonical: "https://embir.xyz/blog/premier-message-application-rencontre" },
  openGraph: {
    title: "Premier message sur une application de rencontre — exemples qui marchent",
    description: "Des exemples concrets de premiers messages qui obtiennent des réponses. Ce qu'il faut dire (et ne pas dire) pour engager la conversation.",
    url: "https://embir.xyz/blog/premier-message-application-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Premier+message+sur+une+application+de+rencontre+—+exemples+qui+marchent&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Le premier message parfait sur une application de rencontre</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            Des exemples concrets de premiers messages qui obtiennent des réponses. Ce qu'il faut dire (et ne pas dire) pour engager la conversation.
          </p>
