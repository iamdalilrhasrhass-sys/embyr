...
export const metadata: Metadata = {
  title: "Alternative à Hinge : quelles applis choisir",
  description: "Alternative à Hinge : quelles applis choisir",
  alternates: { canonical: "https://embir.xyz/blog/alternative-hinge" },
  openGraph: {
    title: "Alternative à Hinge : quelles applis choisir",
    description: "Alternative à Hinge : quelles applis choisir",
    url: "https://embir.xyz/blog/alternative-hinge",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Alternative+à+Hinge+:+quelles+applis+choisir&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Les meilleures alternatives à Hinge</h1>
          <p className="mt-5 text-lg text-white/45">Alternative à Hinge : quelles applis choisir</p>
        </div>
      </header>
