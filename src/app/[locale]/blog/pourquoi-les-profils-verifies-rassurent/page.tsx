...
export const metadata: Metadata = {
  title: "Pourquoi les profils vérifiés rassurent les utilisateurs",
  description: "Pourquoi les profils vérifiés rassurent les utilisateurs",
  alternates: { canonical: "https://embir.xyz/blog/pourquoi-les-profils-verifies-rassurent" },
  openGraph: {
    title: "Pourquoi les profils vérifiés rassurent les utilisateurs",
    description: "Pourquoi les profils vérifiés rassurent les utilisateurs",
    url: "https://embir.xyz/blog/pourquoi-les-profils-verifies-rassurent",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Pourquoi+les+profils+vérifiés+rassurent+les+utilisateurs&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Pourquoi les profils vérifiés changent tout</h1>
          <p className="mt-5 text-lg text-white/45">Pourquoi les profils vérifiés rassurent les utilisateurs</p>
        </div>
      </header>
