...
export const metadata: Metadata = {
  title: "Alternative à Grindr — le comparatif complet 2026",
  description: "Comparatif détaillé des alternatives à Grindr : Embir, Scruff, Romeo, Hornet, Tinder. Prix, sécurité, fonctionnalités. Quelle appli choisir ?",
  alternates: { canonical: "https://embir.xyz/blog/alternative-grindr-2026-comparatif" },
  openGraph: {
    title: "Alternative à Grindr — le comparatif complet 2026",
    description: "Comparatif détaillé des alternatives à Grindr : Embir, Scruff, Romeo, Hornet, Tinder. Prix, sécurité, fonctionnalités. Quelle appli choisir ?",
    url: "https://embir.xyz/blog/alternative-grindr-2026-comparatif",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Alternative+à+Grindr+—+le+comparatif+complet+2026&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Les meilleures alternatives à Grindr en 2026</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Comparatif détaillé des alternatives à Grindr : Embir, Scruff, Romeo, Hornet, Tinder. Prix, sécurité, fonctionnalités. Quelle appli choisir ?</p>
