...
export const metadata: Metadata = {
  title: "Comment éviter les faux comptes sur les applis de rencontre",
  description: "Comment éviter les faux comptes sur les applis de rencontre",
  alternates: { canonical: "https://embir.xyz/blog/comment-eviter-les-faux-comptes" },
  openGraph: {
    title: "Comment éviter les faux comptes sur les applis de rencontre",
    description: "Comment éviter les faux comptes sur les applis de rencontre",
    url: "https://embir.xyz/blog/comment-eviter-les-faux-comptes",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Comment+éviter+les+faux+comptes+sur+les+applis+de+rencontre&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Comment éviter les faux comptes</h1>
          <p className="mt-5 text-lg text-white/45">Comment éviter les faux comptes sur les applis de rencontre</p>
        </div>
      </header>
