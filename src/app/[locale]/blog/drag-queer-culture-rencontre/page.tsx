...
export const metadata: Metadata = {
  title: "Culture drag et queer : l'impact sur les rencontres",
  description: "Culture drag et queer : l'impact sur les rencontres",
  alternates: { canonical: "https://embir.xyz/blog/drag-queer-culture-rencontre" },
  openGraph: {
    title: "Culture drag et queer : l'impact sur les rencontres",
    description: "Culture drag et queer : l'impact sur les rencontres",
    url: "https://embir.xyz/blog/drag-queer-culture-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Culture+drag+et+queer+:+l&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Culture drag et rencontres : ce qui change</h1>
          <p className="mt-5 text-lg text-white/45">Culture drag et queer : l'impact sur les rencontres</p>
        </div>
      </header>
