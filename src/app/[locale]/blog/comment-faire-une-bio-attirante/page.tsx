...
export const metadata: Metadata = {
  title: "Comment faire une bio attirante sur une appli de rencontre",
  description: "Comment faire une bio attirante sur une appli de rencontre",
  alternates: { canonical: "https://embir.xyz/blog/comment-faire-une-bio-attirante" },
  openGraph: {
    title: "Comment faire une bio attirante sur une appli de rencontre",
    description: "Comment faire une bio attirante sur une appli de rencontre",
    url: "https://embir.xyz/blog/comment-faire-une-bio-attirante",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Comment+faire+une+bio+attirante+sur+une+appli+de+rencontre&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Comment faire une bio qui attire vraiment</h1>
          <p className="mt-5 text-lg text-white/45">Comment faire une bio attirante sur une appli de rencontre</p>
        </div>
      </header>
