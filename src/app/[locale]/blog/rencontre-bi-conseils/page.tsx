...
export const metadata: Metadata = {
  title: "Rencontre bi : conseils pour la communauté bisexuelle",
  description: "Rencontre bi : conseils pour la communauté bisexuelle",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-bi-conseils" },
  openGraph: {
    title: "Rencontre bi : conseils pour la communauté bisexuelle",
    description: "Rencontre bi : conseils pour la communauté bisexuelle",
    url: "https://embir.xyz/blog/rencontre-bi-conseils",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+bi+:+conseils+pour+la+communauté+bisexuelle&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rencontre bisexuelle : conseils et guide</h1>
          <p className="mt-5 text-lg text-white/45">Rencontre bi : conseils pour la communauté bisexuelle</p>
        </div>
      </header>
