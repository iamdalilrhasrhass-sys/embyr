...
export const metadata: Metadata = {
  title: "Comment faire des rencontres sérieuses en 2026",
  description: "Guide pour trouver une relation durable via les applications de rencontre. Évitez les pièges du dating superficiel et trouvez des connexions authentiques.",
  alternates: { canonical: "https://embir.xyz/blog/comment-faire-rencontres-serieuses" },
  openGraph: {
    title: "Comment faire des rencontres sérieuses en 2026",
    description: "Guide pour trouver une relation durable via les applications de rencontre. Évitez les pièges du dating superficiel et trouvez des connexions authentiques.",
    url: "https://embir.xyz/blog/comment-faire-rencontres-serieuses",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
  },
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Comment faire des rencontres sérieuses à l'ère du dating rapide</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            Guide pour trouver une relation durable via les applications de rencontre. Évitez les pièges du dating superficiel et trouvez des connexions authentiques.
          </p>
