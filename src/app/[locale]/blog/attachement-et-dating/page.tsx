...
export const metadata: Metadata = {
  title: "Styles d'attachement et dating : comprendre ses schémas",
  description: "Styles d'attachement et dating : comprendre ses schémas",
  alternates: { canonical: "https://embir.xyz/blog/attachement-et-dating" },
  openGraph: {
    title: "Styles d'attachement et dating : comprendre ses schémas",
    description: "Styles d'attachement et dating : comprendre ses schémas",
    url: "https://embir.xyz/blog/attachement-et-dating",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Styles+d&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Styles d'attachement et rencontres</h1>
          <p className="mt-5 text-lg text-white/45">Styles d'attachement et dating : comprendre ses schémas</p>
        </div>
      </header>
