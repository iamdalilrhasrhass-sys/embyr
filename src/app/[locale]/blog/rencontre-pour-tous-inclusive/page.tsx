...
export const metadata: Metadata = {
  title: "Rencontre pour tous — une application vraiment inclusive",
  description: "Embir est conçu pour toutes les orientations et tous les genres. Découvrez une application où chacun trouve sa place, sans jugement.",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-pour-tous-inclusive" },
  openGraph: {
    title: "Rencontre pour tous — une application vraiment inclusive",
    description: "Embir est conçu pour toutes les orientations et tous les genres. Découvrez une application où chacun trouve sa place, sans jugement.",
    url: "https://embir.xyz/blog/rencontre-pour-tous-inclusive",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+pour+tous+—+une+application+vraiment+inclusive&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Une application de rencontre pour tous, vraiment</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Embir est conçu pour toutes les orientations et tous les genres. Découvrez une application où chacun trouve sa place, sans jugement.</p>
