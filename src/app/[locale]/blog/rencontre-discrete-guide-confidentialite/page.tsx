...
export const metadata: Metadata = {
  title: "Rencontre discrète — guide confidentialité et respect",
  description: "Guide pour des rencontres discrètes et respectueuses. Embir protège votre confidentialité : profils ciblés, données sécurisées, zéro exposition.",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-discrete-guide-confidentialite" },
  openGraph: {
    title: "Rencontre discrète — guide confidentialité et respect",
    description: "Guide pour des rencontres discrètes et respectueuses. Embir protège votre confidentialité : profils ciblés, données sécurisées, zéro exposition.",
    url: "https://embir.xyz/blog/rencontre-discrete-guide-confidentialite",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+discrète+—+guide+confidentialité+et+respect&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Rencontre discrète : comment protéger sa vie privée sur les applis</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Guide pour des rencontres discrètes et respectueuses. Embir protège votre confidentialité : profils ciblés, données sécurisées, zéro exposition.</p>
