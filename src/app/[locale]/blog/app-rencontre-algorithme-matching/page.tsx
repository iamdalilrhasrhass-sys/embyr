...
export const metadata: Metadata = {
  ...
  description: "Découvrez comment les algorithmes des applis de rencontre fonctionnent : Elo score, compatibilité réciproque, DeepSeek. Et pourquoi Embir fait différemment.",
  ...
  openGraph: {
    ...
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Comment+fonctionne+l&variant=market`],
  },
};
      ...
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            Découvrez comment les algorithmes des applis de rencontre fonctionnent : Elo score, compatibilité réciproque, DeepSeek. Et pourquoi Embir fait différemment.
          </p>
