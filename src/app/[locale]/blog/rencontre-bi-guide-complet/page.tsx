...
export const metadata: Metadata = {
  title: "Rencontre bi — guide complet pour la communauté bisexuelle",
  description: "Guide pour les personnes bi sur les applis de rencontre. Filtres, visibilité, respect. Embir accueille la bisexualité sans fétichisation.",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-bi-guide-complet" },
  openGraph: {
    title: "Rencontre bi — guide complet pour la communauté bisexuelle",
    description: "Guide pour les personnes bi sur les applis de rencontre. Filtres, visibilité, respect. Embir accueille la bisexualité sans fétichisation.",
    url: "https://embir.xyz/blog/rencontre-bi-guide-complet",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+bi+—+guide+complet+pour+la+communauté+bisexuelle&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Rencontre bisexuelle : un guide complet et bienveillant</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Guide pour les personnes bi sur les applis de rencontre. Filtres, visibilité, respect. Embir accueille la bisexualité sans fétichisation.</p>
