...
export const metadata: Metadata = {
  title: "Premier date gay : comment le réussir",
  description: "Premier date gay : comment le réussir",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-gay-premier-date" },
  openGraph: {
    title: "Premier date gay : comment le réussir",
    description: "Premier date gay : comment le réussir",
    url: "https://embir.xyz/blog/rencontre-gay-premier-date",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Premier+date+gay+:+comment+le+réussir&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Premier date gay : tous nos conseils</h1>
          <p className="mt-5 text-lg text-white/45">Premier date gay : comment le réussir</p>
        </div>
      </header>
