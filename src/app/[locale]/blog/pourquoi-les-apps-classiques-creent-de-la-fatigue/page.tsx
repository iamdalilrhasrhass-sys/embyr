...
export const metadata: Metadata = {
  title: "Pourquoi les applis classiques créent de la fatigue",
  description: "Pourquoi les applis classiques créent de la fatigue",
  alternates: { canonical: "https://embir.xyz/blog/pourquoi-les-apps-classiques-creent-de-la-fatigue" },
  openGraph: {
    title: "Pourquoi les applis classiques créent de la fatigue",
    description: "Pourquoi les applis classiques créent de la fatigue",
    url: "https://embir.xyz/blog/pourquoi-les-apps-classiques-creent-de-la-fatigue",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Pourquoi+les+applis+classiques+créent+de+la+fatigue&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Pourquoi les applis classiques créent de la fatigue</h1>
          <p className="mt-5 text-lg text-white/45">Pourquoi les applis classiques créent de la fatigue</p>
        </div>
      </header>
