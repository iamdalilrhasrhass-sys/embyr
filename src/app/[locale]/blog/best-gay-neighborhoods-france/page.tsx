...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://embir.xyz/blog/best-gay-neighborhoods-france" },
};
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-black mb-6 text-white">Best Gay Neighborhoods in French Cities</h1>
          <div className="prose prose-invert max-w-none text-white/50 space-y-4 leading-relaxed">
            <p>From Paris's historic Le Marais to Lyon's Guillotiere — discover the best gay-friendly neighborhoods in France. At Embir, we believe in authentic dating between men. No ads, no subscriptions, no intrusive algorithm.</p>
          </div>
