...
export const metadata: Metadata = {
  title: "Comment draguer sur une app de rencontre gay ? — Les 7 règles d'or | Embyr Blog",
  ...
  keywords: ["draguer sur app rencontre", "gay", "LGBTQ+", "rencontre gay", "Embyr"],
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-black mb-6 text-white">Comment draguer sur une app de rencontre gay ? — Les 7 règles d'or</h1>
          
          <div className="prose prose-invert max-w-none text-white/50 space-y-4 leading-relaxed">
            <p>Guide de drague gay sur les applications de rencontre. Comment envoyer le premier message, se démarquer, et obtenir des dates.</p>
