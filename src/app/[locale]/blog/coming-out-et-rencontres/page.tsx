...
export const metadata: Metadata = {
  title: "Coming out et rencontres : guide bienveillant",
  description: "Coming out et rencontres : guide bienveillant",
  alternates: { canonical: "https://embir.xyz/blog/coming-out-et-rencontres" },
  openGraph: {
    title: "Coming out et rencontres : guide bienveillant",
    description: "Coming out et rencontres : guide bienveillant",
    url: "https://embir.xyz/blog/coming-out-et-rencontres",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Coming+out+et+rencontres+:+guide+bienveillant&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Coming out et rencontres : un guide</h1>
          <p className="mt-5 text-lg text-white/45">Coming out et rencontres : guide bienveillant</p>
        </div>
      </header>
