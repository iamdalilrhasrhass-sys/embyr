...
export const metadata: Metadata = {
  title: "Rencontre trans — guide bienveillant et respectueux",
  description: "Guide pour les personnes trans sur les applis de rencontre. Sécurité, respect, modération. Embir protège la communauté trans.",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-trans-guide-bienveillant" },
  openGraph: {
    title: "Rencontre trans — guide bienveillant et respectueux",
    description: "Guide pour les personnes trans sur les applis de rencontre. Sécurité, respect, modération. Embir protège la communauté trans.",
    url: "https://embir.xyz/blog/rencontre-trans-guide-bienveillant",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Rencontre+trans+—+guide+bienveillant+et+respectueux&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Rencontre transgenre : un espace sûr pour des connexions authentiques</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Guide pour les personnes trans sur les applis de rencontre. Sécurité, respect, modération. Embir protège la communauté trans.</p>
