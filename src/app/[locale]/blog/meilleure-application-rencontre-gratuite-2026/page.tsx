...
export const metadata: Metadata = {
  ...
  description: "Guide complet des meilleures applications de rencontre gratuites en 2026. Comparatif, avantages et pièges à éviter. Découvrez Embir, 100% gratuit au lancement.",
      ...
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            Guide complet des meilleures applications de rencontre gratuites en 2026. Comparatif, avantages et pièges à éviter. Découvrez Embir, 100% gratuit au lancement.
          </p>
