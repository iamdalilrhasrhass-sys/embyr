...
export const metadata: Metadata = {
  title: "Comment savoir si un mec est gay ? — Les signes qui ne trompent pas | Embyr Blog",
  ...
  keywords: ["comment savoir si un mec est gay", "gay", "LGBTQ+", "rencontre gay", "Embyr"],
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-black mb-6 text-white">Comment savoir si un mec est gay ? — Les signes qui ne trompent pas</h1>
          
          <div className="prose prose-invert max-w-none text-white/50 space-y-4 leading-relaxed">
            <p>Guide complet pour savoir si un mec est gay. Signes, comportements, et comment aborder la discussion sans awkwardness.</p>
