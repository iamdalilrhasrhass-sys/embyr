...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://embir.xyz/blog/serious-relationship-vs-hookup" },
};
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-black mb-6 text-white">Serious Relationship vs Hookup</h1>
          <div className="prose prose-invert max-w-none text-white/50 space-y-4 leading-relaxed">
            <p>Whether you're looking for a committed relationship or casual fun, the most important thing is being honest — with yourself and with others. At Embir, we believe in authentic dating between men. No ads, no subscriptions, no intrusive algorithm.</p>
          </div>
