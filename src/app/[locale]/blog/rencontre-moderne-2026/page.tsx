...
export const metadata: Metadata = {
  title: "La rencontre moderne en 2026 — au-delà du swipe",
  description: "Analyse de l'évolution des rencontres en ligne. Pourquoi les utilisateurs cherchent une expérience plus profonde que le simple swipe.",
  alternates: { canonical: "https://embir.xyz/blog/rencontre-moderne-2026" },
  openGraph: {
    title: "La rencontre moderne en 2026 — au-delà du swipe",
    description: "Analyse de l'évolution des rencontres en ligne. Pourquoi les utilisateurs cherchent une expérience plus profonde que le simple swipe.",
    url: "https://embir.xyz/blog/rencontre-moderne-2026",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=La+rencontre+moderne+en+2026+—+au-delà+du+swipe&variant=market`],
  },
};
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">La rencontre moderne : pourquoi le swipe ne suffit plus en 2026</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">Analyse de l'évolution des rencontres en ligne. Pourquoi les utilisateurs cherchent une expérience plus profonde que le simple swipe.</p>
