...
export const metadata: Metadata = {
  title: "Comment écrire la bio parfaite sur une application de rencontre",
  description: "Guide complet pour rédiger une bio attractive : exemples, erreurs à éviter, structure gagnante. Attirez les profils qui vous correspondent vraiment.",
  alternates: { canonical: "https://embir.xyz/blog/comment-ecrire-bio-parfaite-rencontre" },
  openGraph: {
    title: "Comment écrire la bio parfaite sur une application de rencontre",
    description: "Guide complet pour rédiger une bio attractive : exemples, erreurs à éviter, structure gagnante. Attirez les profils qui vous correspondent vraiment.",
    url: "https://embir.xyz/blog/comment-ecrire-bio-parfaite-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
    ...
    <article className="emb-page min-h-screen">
      <header className="px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.02em] text-white sm:text-5xl">Comment écrire une bio qui fait la différence sur une appli de rencontre</h1>
          <p className="mt-5 text-lg leading-relaxed text-white/45">
            Guide complet pour rédiger une bio attractive : exemples, erreurs à éviter, structure gagnante. Attirez les profils qui vous correspondent vraiment.
          </p>
