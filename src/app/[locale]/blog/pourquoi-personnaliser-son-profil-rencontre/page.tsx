...
export const metadata: Metadata = {
  title: "Pourquoi personnaliser son profil de rencontre fait toute la différence",
  description: "Un profil générique = zéro match. Découvrez pourquoi la personnalisation est le facteur numéro 1 de succès sur les applis de rencontre.",
  alternates: { canonical: "https://embir.xyz/blog/pourquoi-personnaliser-son-profil-rencontre" },
  openGraph: {
    title: "Pourquoi personnaliser son profil de rencontre fait toute la différence",
    description: "Un profil générique = zéro match. Découvrez pourquoi la personnalisation est le facteur numéro 1 de succès sur les applis de rencontre.",
    url: "https://embir.xyz/blog/pourquoi-personnaliser-son-profil-rencontre",
    type: "article",
    locale: "fr_FR",
    siteName: "Embir",
