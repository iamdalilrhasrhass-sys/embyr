...
export const metadata: Metadata = {
  title: "LGBTQ+ Dating App — Inclusive, Free & Verified",
  description: "Embir is an inclusive LGBTQ+ dating app for gay, lesbian, bi, trans, and queer people. Verified profiles, AI matching, zero ads, free during launch.",
alternates: {
    canonical: "https://embir.xyz/lgbtq-dating-app",
    languages: {
      "fr": "https://embir.xyz/rencontre-lgbtq",
    },
  },
  openGraph: {
    title: "LGBTQ+ Dating App — Inclusive, Free & Verified",
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.03em] text-white sm:text-5xl">An LGBTQ+ dating app that welcomes everyone.</h1>
          <p className="mt-6 text-lg leading-relaxed text-white/50">Embir is an inclusive LGBTQ+ dating app for gay, lesbian, bi, trans, and queer people. Verified profiles, AI matching, zero ads, free during launch.</p>
