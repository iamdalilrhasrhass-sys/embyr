...
export const metadata: Metadata = {
  title: "Application de rencontre discrète — confidentialité garantie",
  description: "Embir protège votre vie privée : profils visibles uniquement par les personnes compatibles, navigation discrète. Gratuit au lancement.",
  ...
  openGraph: {
    ...
    locale: "fr_FR",
    siteName: "Embir",
    images: [`/api/og?title=Application+de+rencontre+discrète+—+confidentialité+garantie&variant=market`],
  },
};
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-white/50">Embir protège votre vie privée : profils visibles uniquement par les personnes compatibles, navigation discrète. Gratuit au lancement.</p>
