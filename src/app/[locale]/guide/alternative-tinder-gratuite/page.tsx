...
export const metadata: Metadata = {
  title: "Guide alternative à Tinder gratuite",
  description: "Guide des alternatives à Tinder vraiment gratuites. Comparatif des fonctionnalités, prix et expérience.",
  alternates: { canonical: "https://embir.xyz/guide/alternative-tinder-gratuite" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Les meilleures alternatives gratuites à Tinder</h1><p className="mt-6 text-lg text-white/50">Guide des alternatives à Tinder vraiment gratuites. Comparatif des fonctionnalités, prix et expérience.</p>
