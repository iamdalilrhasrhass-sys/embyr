...
export const metadata: Metadata = {
  title: "Guide applis de rencontre par orientation",
  description: "Guide pour trouver une application de rencontre adaptée à votre orientation sexuelle et vos préférences.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-par-orientation" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Choisir une appli selon son orientation</h1><p className="mt-6 text-lg text-white/50">Guide pour trouver une application de rencontre adaptée à votre orientation sexuelle et vos préférences.</p>
