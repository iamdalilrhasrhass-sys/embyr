...
export const metadata: Metadata = {
  title: "Guide rencontre sérieuse sans payer",
  description: "Guide pour faire des rencontres sérieuses sans payer d'abonnement. Les applis gratuites qui marchent.",
  alternates: { canonical: "https://embir.xyz/guide/rencontre-serieuse-sans-payer" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Trouver l'amour sans abonnement</h1><p className="mt-6 text-lg text-white/50">Guide pour faire des rencontres sérieuses sans payer d'abonnement. Les applis gratuites qui marchent.</p>
