...
export const metadata: Metadata = {
  title: "Guide applis de rencontre 2026",
  description: "Guide 2026 des applications de rencontre : tendances, innovations, IA, gratuité. Tout ce qui change.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-2026-guide" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Le guide complet des applis en 2026</h1><p className="mt-6 text-lg text-white/50">Guide 2026 des applications de rencontre : tendances, innovations, IA, gratuité. Tout ce qui change.</p>
