...
export const metadata: Metadata = {
  title: "Guide applis de rencontre après une rupture",
  description: "Guide pour reprendre les rencontres après une séparation. Timing, état d'esprit, quelle appli choisir.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-apres-rupture" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Se remettre aux rencontres après une rupture</h1><p className="mt-6 text-lg text-white/50">Guide pour reprendre les rencontres après une séparation. Timing, état d'esprit, quelle appli choisir.</p>
