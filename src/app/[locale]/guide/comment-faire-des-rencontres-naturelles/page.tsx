...
export const metadata: Metadata = {
  title: "Guide rencontres naturelles",
  description: "Guide pour sortir du cadre artificiel des applis et créer des connexions authentiques.",
  alternates: { canonical: "https://embir.xyz/guide/comment-faire-des-rencontres-naturelles" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Faire des rencontres plus naturelles</h1><p className="mt-6 text-lg text-white/50">Guide pour sortir du cadre artificiel des applis et créer des connexions authentiques.</p>
