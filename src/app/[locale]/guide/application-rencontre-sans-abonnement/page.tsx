...
export const metadata: Metadata = {
  title: "Guide application de rencontre sans abonnement",
  description: "Découvrez comment trouver une application de rencontre vraiment gratuite, sans abonnement caché. Guide complet avec comparatif et conseils.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-sans-abonnement" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Le guide des applis de rencontre sans abonnement</h1><p className="mt-6 text-lg text-white/50">Découvrez comment trouver une application de rencontre vraiment gratuite, sans abonnement caché. Guide complet avec comparatif et conseils.</p>
