...
export const metadata: Metadata = {
  title: "Guide applis avec profils vérifiés",
  description: "Guide complet sur la vérification des profils dans les applis de rencontre. Selfie, IA, modération : comment ça marche.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-avec-profils-verifies" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Pourquoi choisir une appli avec profils vérifiés</h1><p className="mt-6 text-lg text-white/50">Guide complet sur la vérification des profils dans les applis de rencontre. Selfie, IA, modération : comment ça marche.</p>
