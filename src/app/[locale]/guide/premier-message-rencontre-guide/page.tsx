...
export const metadata: Metadata = {
  title: "Guide premier message",
  description: "Guide complet pour écrire un premier message qui obtient une réponse. Exemples, erreurs à éviter.",
  alternates: { canonical: "https://embir.xyz/guide/premier-message-rencontre-guide" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Le guide du premier message parfait</h1><p className="mt-6 text-lg text-white/50">Guide complet pour écrire un premier message qui obtient une réponse. Exemples, erreurs à éviter.</p>
