...
export const metadata: Metadata = {
  title: "Guide fatigue des applis de rencontre",
  description: "Guide pour surmonter la lassitude des applis de rencontre. Retrouver du plaisir à dater.",
  alternates: { canonical: "https://embir.xyz/guide/fatigue-des-apps-de-rencontre" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Vaincre la fatigue du dating en ligne</h1><p className="mt-6 text-lg text-white/50">Guide pour surmonter la lassitude des applis de rencontre. Retrouver du plaisir à dater.</p>
