...
export const metadata: Metadata = {
  title: "Guide rencontre LGBTQ+ sans abonnement",
  description: "Guide pour la communauté LGBTQ+ : faire des rencontres sans abonnement. Conseils et applis gratuites.",
  alternates: { canonical: "https://embir.xyz/guide/rencontre-lgbtq-sans-abonnement" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rencontres LGBTQ+ sans abonnement</h1><p className="mt-6 text-lg text-white/50">Guide pour la communauté LGBTQ+ : faire des rencontres sans abonnement. Conseils et applis gratuites.</p>
