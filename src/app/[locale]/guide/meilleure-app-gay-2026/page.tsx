...
export const metadata: Metadata = {
  title: "Guide meilleure appli gay 2026",
  description: "Guide meilleure appli gay 2026",
  alternates: { canonical: "https://embir.xyz/guide/meilleure-app-gay-2026" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">La meilleure appli gay en 2026</h1><p className="mt-6 text-lg text-white/50">Guide meilleure appli gay 2026</p>
