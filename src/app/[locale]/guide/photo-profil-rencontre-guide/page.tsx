...
export const metadata: Metadata = {
  title: "Guide photo de profil",
  description: "Guide pour sélectionner et optimiser vos photos de profil sur les applis de rencontre.",
  alternates: { canonical: "https://embir.xyz/guide/photo-profil-rencontre-guide" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Choisir la meilleure photo de profil</h1><p className="mt-6 text-lg text-white/50">Guide pour sélectionner et optimiser vos photos de profil sur les applis de rencontre.</p>
