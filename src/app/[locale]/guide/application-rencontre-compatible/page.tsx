...
export const metadata: Metadata = {
  title: "Guide application de rencontre compatible",
  description: "Guide pour choisir une application de rencontre qui correspond à vos valeurs, votre orientation et vos attentes.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-compatible" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Trouvez une appli compatible avec vos valeurs</h1><p className="mt-6 text-lg text-white/50">Guide pour choisir une application de rencontre qui correspond à vos valeurs, votre orientation et vos attentes.</p>
