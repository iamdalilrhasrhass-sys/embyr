...
export const metadata: Metadata = {
  title: "Guide applis de rencontre pour introvertis",
  description: "Guide spécial introvertis : quelles applis de rencontre privilégier quand on est timide ou réservé.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-pour-introvertis" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Les meilleures applis pour les introvertis</h1><p className="mt-6 text-lg text-white/50">Guide spécial introvertis : quelles applis de rencontre privilégier quand on est timide ou réservé.</p>
