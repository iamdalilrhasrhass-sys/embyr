...
export const metadata: Metadata = {
  title: "Guide rencontre gay sans abonnement",
  description: "Guide pour faire des rencontres gays sans payer d'abonnement. Applis gratuites, lieux, conseils.",
  alternates: { canonical: "https://embir.xyz/guide/rencontre-gay-sans-abonnement" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rencontres gays sans abonnement</h1><p className="mt-6 text-lg text-white/50">Guide pour faire des rencontres gays sans payer d'abonnement. Applis gratuites, lieux, conseils.</p>
