...
export const metadata: Metadata = {
  title: "Guide rencontres par centres d'intérêt",
  description: "Guide pour rencontrer des personnes qui partagent vos centres d'intérêt et vos passions.",
  alternates: { canonical: "https://embir.xyz/guide/rencontre-par-centres-interet" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Faire des rencontres par passion</h1><p className="mt-6 text-lg text-white/50">Guide pour rencontrer des personnes qui partagent vos centres d'intérêt et vos passions.</p>
