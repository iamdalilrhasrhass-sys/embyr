...
export const metadata: Metadata = {
  title: "Guide application de rencontre gratuite sans limite",
  description: "Guide des applis de rencontre qui offrent une Messagerie entre connexions réciproques et des fonctionnalités complètes sans payer. Comparatif 2026.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-gratuite-sans-limite" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Applis de rencontre sans limite gratuite</h1><p className="mt-6 text-lg text-white/50">Guide des applis de rencontre qui offrent une Messagerie entre connexions réciproques et des fonctionnalités complètes sans payer. Comparatif 2026.</p>
