...
export const metadata: Metadata = {
  ...
  description: "Guide des applis de rencontre qui offrent une messagerie illimitée et des fonctionnalités complètes sans payer. Comparatif 2026.",
