...
export const metadata: Metadata = {
  title: "Guide profil vérifié",
  description: "Guide complet sur la vérification des profils : comment ça marche, pourquoi c'est important, quelles applis le font.",
  alternates: { canonical: "https://embir.xyz/guide/profil-verifie-application-rencontre" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Tout savoir sur les profils vérifiés</h1><p className="mt-6 text-lg text-white/50">Guide complet sur la vérification des profils : comment ça marche, pourquoi c'est important, quelles applis le font.</p>
