...
export const metadata: Metadata = {
  title: "Guide algorithme de matching",
  description: "Guide sur le fonctionnement des algorithmes de matching des applis de rencontre. IA, Elo score, compatibilité.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-avec-algorithme" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Comprendre l'algorithme de matching</h1><p className="mt-6 text-lg text-white/50">Guide sur le fonctionnement des algorithmes de matching des applis de rencontre. IA, Elo score, compatibilité.</p>
