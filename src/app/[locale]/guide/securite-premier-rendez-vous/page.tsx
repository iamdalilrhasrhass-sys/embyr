...
export const metadata: Metadata = {
  title: "Guide sécurité premier rendez-vous",
  description: "Guide complet pour un premier rendez-vous en toute sécurité. Checklist, précautions, signaux d'alerte.",
  alternates: { canonical: "https://embir.xyz/guide/securite-premier-rendez-vous" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Sécurité au premier rendez-vous</h1><p className="mt-6 text-lg text-white/50">Guide complet pour un premier rendez-vous en toute sécurité. Checklist, précautions, signaux d'alerte.</p>
