...
export const metadata: Metadata = {
  title: "Guide rencontre discrète en ligne",
  description: "Comment faire des rencontres discrètes en ligne en protégeant sa vie privée. Guide confidentialité.",
  alternates: { canonical: "https://embir.xyz/guide/rencontre-discrete-en-ligne" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Guide des rencontres discrètes</h1><p className="mt-6 text-lg text-white/50">Comment faire des rencontres discrètes en ligne en protégeant sa vie privée. Guide confidentialité.</p>
