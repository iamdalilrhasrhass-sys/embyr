...
export const metadata: Metadata = {
  title: "Guide faux profils",
  description: "Guide complet pour identifier les faux profils sur les applis de rencontre. Signaux d'alerte, vérification.",
  alternates: { canonical: "https://embir.xyz/guide/faux-profils-application-rencontre" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Comment repérer et éviter les faux profils</h1><p className="mt-6 text-lg text-white/50">Guide complet pour identifier les faux profils sur les applis de rencontre. Signaux d'alerte, vérification.</p>
