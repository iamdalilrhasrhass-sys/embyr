...
export const metadata: Metadata = {
  title: "Guide bio application de rencontre",
  description: "Guide pour créer une bio attractive sur une appli de rencontre. Structure, exemples, pièges à éviter.",
  alternates: { canonical: "https://embir.xyz/guide/bio-application-rencontre-guide" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Rédiger la bio parfaite</h1><p className="mt-6 text-lg text-white/50">Guide pour créer une bio attractive sur une appli de rencontre. Structure, exemples, pièges à éviter.</p>
