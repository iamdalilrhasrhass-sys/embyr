...
export const metadata: Metadata = {
  title: "Guide alternative à Grindr gratuite",
  description: "Guide complet pour remplacer Grindr par une application gratuite, sans pub et avec profils vérifiés.",
  alternates: { canonical: "https://embir.xyz/guide/alternative-grindr-gratuite" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Trouver une alternative gratuite à Grindr</h1><p className="mt-6 text-lg text-white/50">Guide complet pour remplacer Grindr par une application gratuite, sans pub et avec profils vérifiés.</p>
