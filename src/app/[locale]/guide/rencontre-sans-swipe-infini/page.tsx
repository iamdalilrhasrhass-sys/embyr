...
export const metadata: Metadata = {
  title: "Guide rencontre sans swipe infini",
  description: "Guide rencontre sans swipe infini",
  alternates: { canonical: "https://embir.xyz/guide/rencontre-sans-swipe-infini" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Dater sans le swipe épuisant</h1><p className="mt-6 text-lg text-white/50">Guide rencontre sans swipe infini</p>
