...
export const metadata: Metadata = {
  title: "Guide rencontre compatible par valeurs",
  description: "Guide rencontre compatible par valeurs",
  alternates: { canonical: "https://embir.xyz/guide/rencontre-compatible-valeurs" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Trouver des personnes qui partagent vos valeurs</h1><p className="mt-6 text-lg text-white/50">Guide rencontre compatible par valeurs</p>
