...
export const metadata: Metadata = {
  title: "Guide : pourquoi les applis fatiguent",
  description: "Guide : pourquoi les applis fatiguent",
  alternates: { canonical: "https://embir.xyz/guide/pourquoi-les-apps-de-rencontre-fatiguent" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Comprendre pourquoi les applis fatiguent</h1><p className="mt-6 text-lg text-white/50">Guide : pourquoi les applis fatiguent</p>
