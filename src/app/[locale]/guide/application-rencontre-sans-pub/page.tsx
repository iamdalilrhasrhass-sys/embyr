...
export const metadata: Metadata = {
  title: "Guide application de rencontre sans pub",
  description: "Guide des applications de rencontre sans publicité. Découvrez comment profiter d'une expérience premium gratuite, sans interruption.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-sans-pub" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Le guide des applis de rencontre sans publicité</h1><p className="mt-6 text-lg text-white/50">Guide des applications de rencontre sans publicité. Découvrez comment profiter d'une expérience premium gratuite, sans interruption.</p>
