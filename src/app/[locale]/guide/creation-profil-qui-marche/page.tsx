...
export const metadata: Metadata = {
  title: "Guide créer un profil qui marche",
  description: "Guide créer un profil qui marche",
  alternates: { canonical: "https://embir.xyz/guide/creation-profil-qui-marche" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Créer un profil de rencontre qui attire</h1><p className="mt-6 text-lg text-white/50">Guide créer un profil qui marche</p>
