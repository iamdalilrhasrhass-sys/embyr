...
export const metadata: Metadata = {
  title: "Guide appli LGBTQ+ gratuite",
  description: "Guide des applications de rencontre LGBTQ+ gratuites. Comparatif, sécurité, inclusivité.",
  alternates: { canonical: "https://embir.xyz/guide/application-rencontre-lgbtq-gratuite" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Les applis LGBTQ+ vraiment gratuites</h1><p className="mt-6 text-lg text-white/50">Guide des applications de rencontre LGBTQ+ gratuites. Comparatif, sécurité, inclusivité.</p>
