...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: isFr ? "Trouve un partenaire d'entraînement par discipline, niveau et ville. Embir filtre par orientation et intention. Sans carte bancaire." : "Find a training partner by discipline, level and city. Embir filters by orientation and intention. Core connections are free.",
    alternates: {
