...
export const metadata: Metadata = {
  ...
  description: "Find your gay partner on Embir. dating app with free core connections for men seeking relationships.",
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <p className="text-white/50 text-lg mb-8 leading-relaxed">Find your gay partner on Embir. dating app with free core connections for men seeking relationships.</p>
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 text-center mb-10">
            ...
            <p className="text-white/50 mb-6">Join Embir now. Core connections are free, real connections.</p>
