...
export const metadata: Metadata = {
  title: "Rencontre Couple Gay — Pour Du Sérieux | Embir",
  description: "Tu cherches une relation sérieuse entre hommes ? Embir est gratuit et respectueux.",
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <p className="text-white/50 text-lg mb-8 leading-relaxed">Tu cherches une relation sérieuse entre hommes ? Embir est gratuit et respectueux.</p>
