...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isFr ? "Rencontres fun et sorties — 100% gratuit | Embir" : "Fun dating and outings — 100% free | Embir",
...
const COPY = {
  fr: {
    ...
    sections: [{"title": "Le fun sans complications", "text": "Le fun, c'est sortir, faire la fête, vivre l'instant. Pas de prise de tête, pas de promesse en l'air. Embir te connecte à des gens qui veulent la même légèreté que toi. Le filtre par intention garantit que tout le monde est sur la même longueur d'onde."}, {"title": "Soirées et événements près de chez toi", "text": "Les ambassadeurs organisent des soirées, des sorties en groupe, des événements dans ta ville. Tu rejoins, tu rencontres, tu t'amuses. Le fun est mieux à plusieurs — Embir te donne le groupe."}, {"title": "Zéro jugement", "text": "Chercher du fun n'est pas honteux. Embir ne juge pas tes intentions. Que tu cherches des soirées, des concerts, des sorties improvisées — chaque intention a sa place, sans morale imposée."}, {"title": "Le filtre qui évite les malentendus", "text": "Quelqu'un qui cherche l'amour ne verra pas ton profil 'fun'. Quelqu'un qui cherche un plan cul non plus. Chacun son univers, chacun son intention. Le fun reste le fun, sans confusion."}],
    faq: [{"q": "Le fun signifie-t-il automatiquement plan cul ?", "a": "Non. Fun et plan cul sont deux intentions séparées sur Embir. Fun = sortir, faire la fête, s'amuser en groupe. Plan cul = rencontre sexuelle. Tu choisis ce que tu veux, sans confusion."}, {"q": "Comment trouver des soirées près de chez moi ?", "a": "Les ambassadeurs organisent des événements dans les grandes villes. Tu peux filtrer le feed par intention 'fun' et voir les profils qui proposent ou cherchent des sorties."}, {"q": "C'est sûr de rencontrer des gens pour faire la fête ?", "a": "Les profils vérifiés ont un badge. Les événements organisés par les ambassadeurs sont encadrés. Comme partout, reste prudent : rencontre en public la première fois."}, {"q": "Le fun est-il vraiment gratuit ?", "a": "Oui, 100% gratuit. Messagerie, événements, matching — tout est gratuit. Pas d'abonnement, pas de pub."}, {"q": "Puis-je chercher fun ET amour ?", "a": "Oui. Tu peux sélectionner plusieurs intentions. Embir te montrera les profils qui partagent au moins une de tes intentions."}],
    links: [
  ...
  en: {
    ...
    sections: [{"title": "Fun without complications", "text": "Fun is going out, partying, living the moment. No overthinking, no empty promises. Embir connects you with people who want the same lightness. The intention filter guarantees everyone is on the same page."}, {"title": "Parties and events near you", "text": "Ambassadors organize parties, group outings, events in your city. You join, you meet, you have fun. Fun is better together — Embir gives you the group."}, {"title": "Zero judgment", "text": "Looking for fun is not shameful. Embir doesn't judge your intentions. Whether you're looking for parties, concerts, spontaneous outings — every intention has its place, no imposed morality."}, {"title": "The filter that prevents misunderstandings", "text": "Someone looking for love won't see your 'fun' profile. Someone looking for casual sex won't either. Each person their own world, each person their own intention. Fun stays fun, no confusion."}],
    faq: [{"q": "Does fun automatically mean casual sex?", "a": "No. Fun and casual sex are two separate intentions on Embir. Fun = going out, partying, having fun in a group. Casual sex = sexual encounter. You choose what you want, no confusion."}, {"q": "How do I find parties near me?", "a": "Ambassadors organize events in major cities. You can filter the feed by 'fun' intention and see profiles offering or looking for outings."}, {"q": "Is it safe to meet people for partying?", "a": "Verified profiles have a badge. Events organized by ambassadors are supervised. As anywhere, be cautious: meet in public the first time."}, {"q": "Is fun really free?", "a": "Yes, 100% free. Messaging, events, matching — everything is free. No subscription, no ads."}, {"q": "Can I look for fun AND love?", "a": "Yes. You can select multiple intentions. Embir will show you profiles that share at least one of your intentions."}],
    links: [
