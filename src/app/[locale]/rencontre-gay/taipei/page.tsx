        ...
        <div className="emb-container max-w-3xl">
          ...
          <div className="grid gap-4 sm:grid-cols-3 mb-10">
            ...
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-center">
              ...
              <div className="text-white/40 text-sm mt-1">Mecs près de Taipei</div>
            </div>
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-center">
              <div className="text-3xl mb-2">🔒</div>
          ...
          <div className="rounded-2xl border border-rose-400/10 bg-gradient-to-br from-rose-500/[0.04] to-amber-500/[0.04] p-8 text-center mb-10">
            <h2 className="text-2xl font-bold text-white mb-3">Prêt à rencontrer des mecs à Taipei ?</h2>
            <p className="text-white/50 mb-6">Rejoins les 2.5M habitants de Taipei — quartiers comme Ximending, Zhongshan, Da'an, Xinyi, Gongguan.</p>
          ...
          <div className="prose prose-invert max-w-none text-white/50 space-y-4">
            ...
            <h3 className="text-white/80 text-lg font-semibold">Quartiers gay-friendly près de Taipei</h3>
            <p>Ximending, Zhongshan, Da'an, Xinyi, Gongguan, les quartiers où la communauté gay est la plus active.</p>
          </div>
        </div>
      </section>
    </main>
