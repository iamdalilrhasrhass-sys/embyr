...
export const metadata: Metadata = {
  title: "Gay Dating New York — Free Gay App | Embyr",
  description: "Gay dating in New York on Embyr. 100% free app, no ads, no premium. Create your profile and meet guys near you in New York.",
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <p className="text-white/50 text-lg mb-8 leading-relaxed">
            Looking to meet guys in New York? Embyr is the 100% free gay dating app. 
          ...
          <div className="rounded-2xl border border-rose-400/10 bg-gradient-to-br from-rose-500/[0.04] to-amber-500/[0.04] p-8 text-center mb-10">
            ...
            <p className="text-white/50 mb-6">Join 8.3M people in New York already discovering Embyr.</p>
