...
export const metadata: Metadata = {
  title: "Rencontre Gay Montpellier — App 100% Gratuite | Embyr",
  description: "Rencontre gay à Montpellier sur Embyr. App 100% gratuite sans pubs. Crée ton profil et rencontre des mecs près de chez toi à Montpellier.",
  keywords: ["rencontre gay Montpellier", "gay Montpellier", "rencontre mec Montpellier", "app gay Montpellier", "dating gay Montpellier"],
  alternates: { canonical: "https://embir.xyz/rencontre-gay/montpellier" },
};
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-black mb-6">
            Rencontre gay à <span className="bg-gradient-to-r from-rose-300 via-amber-300 to-purple-300 bg-clip-text text-transparent">Montpellier</span>
          </h1>
          <p className="text-white/50 text-lg mb-8 leading-relaxed">
            Tu cherches des rencontres entre hommes à Montpellier ? Embyr est l&apos;app de rencontre gay 100% gratuite. 
          ...
          <div className="grid gap-4 sm:grid-cols-3 mb-10">
            ...
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-center">
              ...
              <div className="text-white/40 text-sm mt-1">Mecs près de Montpellier</div>
            </div>
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-center">
              <div className="text-3xl mb-2">🔒</div>
          ...
          <div className="rounded-2xl border border-rose-400/10 bg-gradient-to-br from-rose-500/[0.04] to-amber-500/[0.04] p-8 text-center mb-10">
            <h2 className="text-2xl font-bold text-white mb-3">Prêt à rencontrer des mecs à Montpellier ?</h2>
            <p className="text-white/50 mb-6">Rejoins les 290k habitants de Montpellier déjà sur Embyr.</p>
          ...
          <div className="prose prose-invert max-w-none text-white/50 space-y-4">
            <h2 className="text-white text-xl font-bold">Pourquoi choisir Embyr pour tes rencontres gay à Montpellier ?</h2>
            <p>
              Embyr est conçu pour les hommes qui cherchent des rencontres authentiques à Montpellier. 
