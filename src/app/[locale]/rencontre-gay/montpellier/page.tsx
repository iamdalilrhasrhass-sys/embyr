...
export const metadata: Metadata = {
  title: "Rencontre Gay Montpellier — App 100% Gratuite | Embir",
  description: "Rencontre gay à Montpellier sur Embir. App 100% gratuite sans pubs. Crée ton profil et rencontre des mecs près de chez toi à Montpellier.",
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <p className="text-white/50 text-lg mb-8 leading-relaxed">
            Tu cherches des rencontres entre hommes à Montpellier ? Embir est l&apos;app de rencontre gay 100% gratuite. 
          ...
          <div className="rounded-2xl border border-rose-400/10 bg-gradient-to-br from-rose-500/[0.04] to-amber-500/[0.04] p-8 text-center mb-10">
            ...
            <p className="text-white/50 mb-6">Rejoins les 290k habitants de Montpellier déjà sur Embir.</p>
          ...
          <div className="prose prose-invert max-w-none text-white/50 space-y-4">
            <h2 className="text-white text-xl font-bold">Pourquoi choisir Embir pour tes rencontres gay à Montpellier ?</h2>
            <p>
              Embir est conçu pour les hommes qui cherchent des rencontres authentiques à Montpellier. 
