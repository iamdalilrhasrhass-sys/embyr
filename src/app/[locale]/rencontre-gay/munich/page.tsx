...
export const metadata: Metadata = {
  title: "Gay Dating in Munich — app with free core connections",
  description: "Gay dating in Munich on Embir. app with free core connections with no ads. Create your profile and meet guys near you in Munich.",
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <p className="text-white/50 text-lg mb-8 leading-relaxed">
            Looking to meet men in Munich? Embir is the gay dating app with free core connections.
