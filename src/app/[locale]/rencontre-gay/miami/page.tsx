...
export const metadata: Metadata = {
  title: "Gay Dating in Miami — 100% Free App | Embir",
  description: "Gay dating in Miami on Embir. 100% free app with no ads. Create your profile and meet guys near you in Miami.",
  keywords: ["gay dating Miami", "gay Miami", "meet guys Miami", "gay app Miami", "LGBTQ Miami"],
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-black mb-6 text-white">
            Gay dating in <span className="text-white/70">Miami</span>
          </h1>
          <p className="text-white/50 text-lg mb-8 leading-relaxed">
            Looking to meet men in Miami? Embir is the 100% free gay dating app.
          ...
          <div className="grid gap-4 sm:grid-cols-3 mb-10">
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 text-center">
              ...
              <div className="text-white/40 text-sm">Guys near Miami</div>
            </div>
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 text-center">
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 text-center mb-10">
            <h2 className="text-2xl font-bold text-white mb-3">Ready to meet guys in Miami?</h2>
            <p className="text-white/50 mb-6">Join the Miami launch and help Embir build its first local community.</p>
          ...
          <div className="prose prose-invert max-w-none text-white/50 space-y-4">
            <h2 className="text-white text-xl font-bold">Why choose Embir for gay dating in Miami?</h2>
            <p>
              Embir is built for men seeking authentic connections in Miami.
