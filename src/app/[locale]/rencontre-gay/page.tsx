...
export const metadata: Metadata = {
  title: "Application de rencontre gay — gratuite et sans pub",
  description: "Embir est l'application de rencontre gay qui respecte ses utilisateurs : profils vérifiés, Messagerie entre connexions réciproques, zéro publicité, matching intelligent.",
  alternates: { canonical: "https://embir.xyz/rencontre-gay" },
  openGraph: {
    title: "Application de rencontre gay — gratuite et sans pub",
    description: "Embir est l'application de rencontre gay qui respecte ses utilisateurs : profils vérifiés, Messagerie entre connexions réciproques, zéro publicité, matching intelligent.",
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.03em] text-white sm:text-5xl">Une application de rencontre gay pensée pour des connexions authentiques.</h1>
          <p className="mt-6 text-lg leading-relaxed text-white/50">Embir est l'application de rencontre gay qui respecte ses utilisateurs : profils vérifiés, Messagerie entre connexions réciproques, zéro publicité, matching intelligent.</p>
