...
export const metadata: Metadata = {
  ...
  description: "Embir est l'application de rencontre gay qui respecte ses utilisateurs : profils vérifiés, messagerie illimitée, zéro publicité, matching intelligent.",
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-white/50">Embir est l'application de rencontre gay qui respecte ses utilisateurs : profils vérifiés, messagerie illimitée, zéro publicité, matching intelligent.</p>
