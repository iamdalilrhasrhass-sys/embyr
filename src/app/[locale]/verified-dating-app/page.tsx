...
export const metadata: Metadata = {
  title: "Verified Dating App — No Fake Profiles, Real Connections",
  description: "Embir verifies every member by selfie. No catfish, no bots, no fake profiles. A dating app built on trust, free during launch.",
alternates: {
    canonical: "https://embir.xyz/verified-dating-app",
    languages: {
      "fr": "https://embir.xyz/profils-verifies",
    },
  },
  openGraph: {
    title: "Verified Dating App — No Fake Profiles, Real Connections",
      ...
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#d4a574]/20 bg-[#d4a574]/5 px-4 py-1.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[#d4a574]/80">Verified</span>
          </div>
          <h1 className="font-serif text-4xl font-light tracking-[-0.03em] text-white sm:text-5xl">A dating app where every profile is verified.</h1>
          <p className="mt-6 text-lg leading-relaxed text-white/50">Embir verifies every member by selfie. No catfish, no bots, no fake profiles. A dating app built on trust, free during launch.</p>
