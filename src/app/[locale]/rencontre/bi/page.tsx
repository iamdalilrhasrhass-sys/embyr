...
export const metadata: Metadata = {
  ...
  description: "Embir accueille la communauté bi avec des filtres d'orientation personnalisables. Profils vérifiés, gratuit au lancement.",
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 text-lg text-white/50">Embir accueille la communauté bi avec des filtres d'orientation personnalisables. Profils vérifiés, gratuit au lancement.</p>
