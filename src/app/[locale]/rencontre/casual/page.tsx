  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-embir-rose/20 bg-embir-rose/5 px-4 py-1.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-embir-rose/80">Rencontre Casual</span>
          </div>
          <h1 className="font-serif text-4xl font-light tracking-[-0.03em] text-white sm:text-5xl">La rencontre casual,<br/><span className="text-embir-rose">légère et sans prise de tête.</span></h1>
          ...
          <div className="mt-8 flex gap-4">
            <Link prefetch={false} href="/auth/register?source=rencontre-casual" className="inline-flex items-center gap-2 rounded-full bg-embir-rose px-8 py-4 text-sm font-bold text-embir-void hover:bg-embir-blush">Créer mon profil gratuit</Link>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-4">
            <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02]">
              <summary className="cursor-pointer px-6 py-4 text-sm font-semibold text-white/80 group-open:text-embir-rose list-none [&::-webkit-details-marker]:hidden">Embir est-il vraiment adapté aux rencontres casual ?</summary>
            ...
            <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02]">
              <summary className="cursor-pointer px-6 py-4 text-sm font-semibold text-white/80 group-open:text-embir-rose list-none [&::-webkit-details-marker]:hidden">Faut-il payer pour accéder au casual dating sur Embir ?</summary>
            ...
            <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02]">
              <summary className="cursor-pointer px-6 py-4 text-sm font-semibold text-white/80 group-open:text-embir-rose list-none [&::-webkit-details-marker]:hidden">Puis-je changer d'intention plus tard ?</summary>
      ...
      <section className="px-4 pb-16 text-center">
        <Link prefetch={false} href="/auth/register?source=rencontre-casual" className="inline-flex items-center gap-2 rounded-full bg-embir-rose px-10 py-4 text-sm font-bold text-embir-void hover:bg-embir-blush">Commencer les rencontres casual gratuitement</Link>
