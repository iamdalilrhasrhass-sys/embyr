        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-4">
            ...
            <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02]">
              ...
              <p className="px-6 pb-4 text-sm text-white/45">Embir est en phase de lancement. La communauté Marseille grandit chaque jour. En tant que membre fondateur, vous faites partie des premiers à rejoindre.</p>
            </details>
            <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02]">
