...
export const metadata: Metadata = {
  ...
  description: "Découvrez Embir pour faire des rencontres à Besançon. Application de rencontre gratuite pour les connexions essentielles avec profils vérifiés et matching intelligent.",
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-embir-rose/20 bg-embir-rose/5 px-4 py-1.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-embir-rose/80">Besançon</span>
          </div>
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Faire des rencontres à Besançon<br/><span className="text-embir-rose">n'a jamais été aussi simple.</span></h1>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8 bg-white/[0.01]">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6"><h3 className="text-lg font-bold text-white mb-2">Profils vérifiés</h3><p className="text-sm text-white/45">La vérification par selfie est disponible à Besançon. Un badge visible identifie les profils vérifiés ; aucun système n’élimine tout risque.</p></div>
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6"><h3 className="text-lg font-bold text-white mb-2">Matching intelligent</h3><p className="text-sm text-white/45">La sélection applique vos préférences déclarées dans les deux sens à Besançon.</p></div>
        ...
        <div className="mx-auto max-w-3xl"><h2 className="font-serif text-3xl text-white mb-8">FAQ</h2>
          <div className="space-y-4">
            <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02]">
              <summary className="cursor-pointer px-6 py-4 text-sm font-semibold text-white/80 group-open:text-embir-rose list-none [&::-webkit-details-marker]:hidden">Embir est-il disponible à Besançon ?</summary>
      ...
      <section className="px-4 pb-16 text-center">
        <Link prefetch={false} href="/auth/register" className="inline-flex items-center gap-2 rounded-full bg-embir-rose px-10 py-4 text-sm font-bold text-embir-void hover:bg-embir-blush">Créer mon profil gratuit à Besançon</Link>
      </section>
    </main>
  );
}