  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-embir-rose/20 bg-embir-rose/5 px-4 py-1.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-embir-rose/80">Annecy</span>
          </div>
          <h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Faire des rencontres à Annecy<br/><span className="text-embir-rose">n'a jamais été aussi simple.</span></h1>
          <p className="mt-6 text-lg text-white/50">Annecy, la Venise des Alpes, offre un cadre idéal pour les rencontres. Avec Embir, trouvez des profils compatibles près de chez vous.</p>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h2 className="font-serif text-3xl text-white mb-8">Quartiers de Annecy</h2><p className="text-white/45">Embir couvre tous les quartiers : du Pâquier aux bords du lac, en passant par la vieille ville.</p></div>
      </section>
      <section className="px-4 py-16 sm:px-6 lg:px-8 bg-white/[0.01]">
        <div className="mx-auto max-w-3xl"><h2 className="font-serif text-3xl text-white mb-8">FAQ</h2>
          <div className="space-y-4">
            <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02]">
              <summary className="cursor-pointer px-6 py-4 text-sm font-semibold text-white/80 group-open:text-embir-rose list-none [&::-webkit-details-marker]:hidden">Embir est-il disponible à Annecy ?</summary>
              <p className="px-6 pb-4 text-sm text-white/45">Oui, Embir est disponible à Annecy et dans toutes les villes françaises.</p>
            </details>
            <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02]">
      ...
      <section className="px-4 pb-16 text-center">
        <Link prefetch={false} href="/auth/register" className="inline-flex items-center gap-2 rounded-full bg-embir-rose px-10 py-4 text-sm font-bold text-embir-void hover:bg-embir-blush">Créer mon profil gratuit à Annecy</Link>
      </section>
    </main>
  );
}