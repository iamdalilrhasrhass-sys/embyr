...
export const metadata: Metadata = {
  ...
  description: "Découvrez Embir pour des rencontres homme-femme. Application gratuite au lancement, profils vérifiés et matching intelligent.",
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 text-lg text-white/50">Découvrez Embir pour des rencontres homme-femme. Application gratuite au lancement, profils vérifiés et matching intelligent.</p>
