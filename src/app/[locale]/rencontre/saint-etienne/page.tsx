...
export const metadata: Metadata = {
  ...
  description: "Découvrez Embir pour faire des rencontres à Saint-Étienne. Application de rencontre gratuite au lancement avec profils vérifiés et matching intelligent.",
  alternates: { canonical: "https://embir.xyz/rencontre/saint-etienne" },
  openGraph: {
    title: "Rencontre à Saint-Étienne",
    description: "Application de rencontre gratuite à Saint-Étienne. Profils vérifiés, matching IA, zéro pub.",
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
              ...
              <p className="text-sm text-white/45">Chaque profil à Saint-Étienne est vérifié par selfie. Fini les faux profils et les mauvaises surprises.</p>
            </div>
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
              <h3 className="text-lg font-bold text-white mb-2">Matching intelligent</h3>
              <p className="text-sm text-white/45">Notre IA comprend vos préférences et vous suggère des profils compatibles à Saint-Étienne et dans les environs.</p>
            </div>
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-4">
            ...
            <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02]">
              ...
              <p className="px-6 pb-4 text-sm text-white/45">Embir est en phase de lancement. La communauté Saint-Étienne grandit chaque jour. En tant que membre fondateur, vous faites partie des premiers à rejoindre.</p>
            </details>
            <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02]">
