...
export const metadata: Metadata = {
  title: "Free Dating App — No Ads, Verified Profiles",
  description: "Embir is a free dating app with verified profiles, AI matching, and zero ads. Messaging is unlimited during launch. Join the founding members.",
alternates: {
    canonical: "https://embir.xyz/free-dating-app",
    languages: {
      "fr": "https://embir.xyz/application-rencontre-gratuite",
    },
  },
  openGraph: {
    title: "Free Dating App — No Ads, Verified Profiles",
      ...
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#d4a574]/20 bg-[#d4a574]/5 px-4 py-1.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[#d4a574]/80">Free Dating</span>
          </div>
          <h1 className="font-serif text-4xl font-light tracking-[-0.03em] text-white sm:text-5xl">A free dating app that actually respects you.</h1>
          <p className="mt-6 text-lg leading-relaxed text-white/50">Embir is a free dating app with verified profiles, AI matching, and zero ads. Messaging is unlimited during launch. Join the founding members.</p>
