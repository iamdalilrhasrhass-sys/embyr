...
export const metadata: Metadata = {
  title: "Gay Dating App — The Best app with free core connections",
  description: "The best gay dating app. Core connections are free, no ads, English and French public pages. Meet guys near you.",
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-black mb-6 text-white">The Best Gay Dating App</h1>
          <p className="text-white/50 text-lg mb-8 leading-relaxed">The best gay dating app. Core connections are free, no ads, English and French public pages. Meet guys near you.</p>
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 text-center mb-10">
            ...
            <p className="text-white/50 mb-6">Join Embir now. Core connections are free, no ads, no catch.</p>
