...
export const metadata: Metadata = {
  title: "Gay Dating App — The Best 100% Free App | Embir",
  description: "The best gay dating app. 100% free, no ads, 25 languages. Meet guys near you.",
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <p className="text-white/50 text-lg mb-8 leading-relaxed">The best gay dating app. 100% free, no ads, 25 languages. Meet guys near you.</p>
