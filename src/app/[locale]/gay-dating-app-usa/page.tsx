      ...
      <section className="relative px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-embir-rose/20 bg-embir-rose/5 px-4 py-1.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-embir-rose/80">United States</span>
          </div>
          <h1 className="font-serif text-4xl font-light tracking-[-0.03em] text-white sm:text-5xl md:text-6xl">
            A free gay dating app<br />
            <span className="text-embir-rose">built for the USA.</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <TrackedLink href="/auth/register?source=usa-landing" label="Create my free profile" location="usa-landing-hero" className="inline-flex items-center gap-2 rounded-full bg-embir-rose px-8 py-4 text-sm font-bold text-embir-void transition-all hover:bg-embir-blush hover:shadow-[0_0_40px_rgba(216,139,167,0.3)]">
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8 bg-white/[0.01]">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="mt-4 text-center font-serif text-3xl font-light tracking-[-0.02em] text-white sm:text-4xl">
            ...
            <span className="text-embir-rose">every major US city.</span>
          </h2>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-serif text-3xl font-light tracking-[-0.02em] text-white sm:text-4xl">
            ...
            <span className="text-embir-rose">without the paywalls?</span>
          </h2>
          <p className="mt-4 text-white/35">Free. Verified. No ads. Just real connections.</p>
          <Link href="/auth/register?source=usa-landing" className="mt-8 inline-flex items-center gap-2 rounded-full bg-embir-rose px-10 py-4 text-sm font-bold text-embir-void transition-all hover:bg-embir-blush hover:shadow-[0_0_40px_rgba(216,139,167,0.3)]">
            Create my free profile
          </Link>
      ...
      <section className="px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/blog/best-free-gay-dating-apps-2026" className="text-sm text-white/35 hover:text-embir-rose transition-colors underline underline-offset-4">Best free gay dating apps 2026</Link>
            ...
            <span className="text-white/10">·</span>
            <Link href="/grindr-vs-alternatives" className="text-sm text-white/35 hover:text-embir-rose transition-colors underline underline-offset-4">Grindr vs alternatives</Link>
            <span className="text-white/10">·</span>
            <Link href="/new-york" className="text-sm text-white/35 hover:text-embir-rose transition-colors underline underline-offset-4">Gay dating New York</Link>
            <span className="text-white/10">·</span>
