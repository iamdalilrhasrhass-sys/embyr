...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: isFr ? "Des amis vrais, pas des followers. Embir connecte par affinités réelles, par ville. 100% gratuit, sans confusion avec le dating." : "Real friends, not followers. Embir connects by shared interests, by city. 100% free, no confusion with dating.",
    alternates: {
...
const COPY = {
  ...
  en: {
    ...
    sections: [{"title": "Friendship has its place", "text": "On most apps, everything is mixed. Someone looking for a friend ends up facing someone looking for love. Embir separates. If you choose 'friends' as your intention, you only see profiles also looking for friendship. No misunderstanding, no awkwardness."}, {"title": "By real affinities", "text": "Embir matches by shared passions: sports, music, gaming, cooking, travel. You find people who love what you love, in your city. Not random connections — real affinities."}, {"title": "Local events and activities", "text": "Embir ambassadors organize events in your city: meetups, workshops, sports outings. You join a group, meet in person, friendship builds naturally. Not behind a screen."}, {"title": "No confusion with dating", "text": "The intention filter guarantees that profiles looking for love won't see your 'friends' profile. And vice versa. Everyone seeks what they want without stepping on others. That's bidirectional respect."}],
    faq: [{"q": "Can I look only for friends?", "a": "Yes. Select the 'friends' intention during signup. You'll only see profiles also looking for friendship. Profiles looking for love won't see you."}, {"q": "Will profiles looking for love see me?", "a": "No. The intention filter is bidirectional. If you're looking for friends and they're looking for love, neither of you will see the other. No confusion."}, {"q": "Can I look for friends AND love at the same time?", "a": "Yes. You can select multiple intentions. Embir will show you profiles that share at least one of your intentions."}, {"q": "Are there groups by passion?", "a": "Ambassadors organize themed events (sports, music, food). You can also filter the feed by activity to find people who share your passions."}, {"q": "Is it really free to make friends?", "a": "Yes, 100% free. Unlimited messaging, free events, no paid features. Friendship doesn't have a monthly price."}],
    links: [
