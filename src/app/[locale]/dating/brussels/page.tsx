...
export const metadata: Metadata = {
  ...
  description: "Discover Embir for dating in Brussels. Free dating app with verified profiles, smart AI matching, and zero ads. Join Brussels's dating community.",
  alternates: { canonical: "https://embir.xyz/dating/brussels" },
  openGraph: {
    title: "Dating in Brussels",
    description: "Free dating app in Brussels. Verified profiles, AI matching, no ads.",
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 text-lg text-white/50">Brussels, the heart of Europe, is full of people looking for genuine connections. Embir brings verified profiles and AI matching to Brussels's dating scene — completely free during launch.</p>
