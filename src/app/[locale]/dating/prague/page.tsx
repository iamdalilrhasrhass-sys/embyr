      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8 bg-white/[0.01]">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6"><h3 className="text-lg font-bold text-white mb-2">Smart AI Matching</h3><p className="text-sm text-white/45">our compatibility system suggests profiles based on your preferences for truly compatible matches in Prague.</p></div>
