...
export const metadata: Metadata = {
  title: "Meilleures alternatives à Tinder en 2026",
  description: "Comparatif des meilleures alternatives à Tinder : Embir, Bumble, Hinge. Gratuité, sérieux, vérification.",
  alternates: { canonical: "https://embir.xyz/comparaison/meilleures-alternatives-tinder" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Les meilleures alternatives à Tinder</h1><p className="mt-6 text-lg text-white/50">Comparatif des meilleures alternatives à Tinder : Embir, Bumble, Hinge. Gratuité, sérieux, vérification.</p></div>
      </section>
      <section className="px-4 py-16 sm:px-6 lg:px-8 bg-white/[0.01]">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02]">
            <div className="grid grid-cols-3 border-b border-white/[0.04] px-6 py-4 text-sm font-semibold text-white/30 uppercase"><div>Critère</div><div className="text-center">Tinder</div><div className="text-center text-[#d4a574]">Embir</div></div>
