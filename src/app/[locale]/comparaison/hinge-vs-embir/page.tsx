...
export const metadata: Metadata = {
  title: "Hinge vs Embir — Comparaison 2026",
  description: "Comparaison entre Hinge et Embir : prix, fonctionnalités, publicités, vérification. Découvrez l'alternative moderne à Hinge.",
  alternates: { canonical: "https://embir.xyz/comparaison/hinge-vs-embir" },
};
  ...
  return (
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl"><h1 className="font-serif text-4xl font-light text-white sm:text-5xl">Hinge vs Embir : le comparatif honnête</h1><p className="mt-6 text-lg text-white/50">Comparaison entre Hinge et Embir : prix, fonctionnalités, publicités, vérification. Découvrez l'alternative moderne à Hinge.</p></div>
      </section>
      <section className="px-4 py-16 sm:px-6 lg:px-8 bg-white/[0.01]">
        <div className="mx-auto max-w-4xl">
          <h2 className="font-serif text-3xl text-white mb-8">Hinge vs Embir — les différences</h2>
          <div className="overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02]">
            <div className="grid grid-cols-3 border-b border-white/[0.04] px-6 py-4 text-sm font-semibold text-white/30 uppercase"><div>Critère</div><div className="text-center">Hinge</div><div className="text-center text-[#d4a574]">Embir</div></div>
