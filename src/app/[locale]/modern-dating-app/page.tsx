...
export const metadata: Metadata = {
  ...
  description: "Embir is a modern dating app using DeepSeek AI for intelligent matching. Verified profiles, zero ads, inclusive for all orientations. Free during launch.",
alternates: {
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-white/50">Embir is a modern dating app using DeepSeek AI for intelligent matching. Verified profiles, zero ads, inclusive for all orientations. Free during launch.</p>
