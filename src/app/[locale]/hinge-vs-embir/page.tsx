...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: isFr ? "Comparatif complet Hinge vs Embir. Prix, fonctionnalites, securite, profils. Embir est gratuit au lancement, Hinge est payant. Decouvre pourquoi Embir gagne." : "Full Hinge vs Embir comparison. Price, features, security, profiles. Embir is free at launch, Hinge is paid. Discover why Embir wins.",
    alternates: {
...
const DATA = {
  fr: {
    ...
    competitorCons: ["Payant (35 EUR/mois pour les likes illimites)", "Filtres limites en version gratuite", "Pas de filtre par orientation LGBT+", "Publicite intrusive des abonnements"],
    embirPros: ["gratuit au lancement — toutes les fonctionnalites", "Filtre strict par orientation (hetero/gay/bi/queer)", "Multi-intentions: amour, amis, fun, sport, evenements", "Profils verifies par selfie", "Aucune pub, aucun paywall"],
    embirCons: ["Plus recent sur le marche", "Moins d'utilisateurs pour l'instant"],
    faq: [["Embir est-il vraiment gratuit alors que Hinge est payant?", "Oui. Embir est gratuit au lancement : messages illimites, likes illimites, tous les filtres, tout. Hinge limite tes likes a 8/jour gratuitement et fait payer 35 EUR/mois pour les likes illimites."], ["Le filtre par orientation d'Embir est-il meilleur que Hinge?", "Oui. Hinge n'a pas de filtre strict par orientation. Embir filtre bidirectionnellement : un hetero ne voit jamais un profil gay, et vice-versa, sauf si tu choisis explicitement de chercher plusieurs genres."], ["Puis-je chercher des amis sur Embir comme sur Hinge?", "Oui. Embir va plus loin que Hinge avec 6 intentions distinctes : amour, amis, fun, plan cul, sport, evenements. Hinge se concentre uniquement sur les relations amoureuses."]],
  },
  en: {
