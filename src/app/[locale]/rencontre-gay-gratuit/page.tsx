...
export const metadata: Metadata = {
  title: "Rencontre Gay Gratuit — App 100% Gratuite Sans Pubs | Embir",
  description: "Rencontre gay 100% gratuit sur Embir. Pas de premium caché, pas de pubs.",
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          ...
          <p className="text-white/50 text-lg mb-8 leading-relaxed">Rencontre gay 100% gratuit sur Embir. Pas de premium caché, pas de pubs.</p>
