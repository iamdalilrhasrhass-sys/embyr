...
export const metadata: Metadata = {
  title: "Application de rencontre LGBTQ+ inclusive et respectueuse",
  description: "Embir est une application inclusive pour les rencontres LGBTQ+ : gay, lesbienne, bi, trans, queer. Profils vérifiés, filtres d'orientation, zéro pub.",
alternates: {
    canonical: "https://embir.xyz/rencontre-lgbtq",
    languages: {
      "en": "https://embir.xyz/lgbtq-dating-app",
    },
  },
  openGraph: {
    title: "Application de rencontre LGBTQ+ inclusive et respectueuse",
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="font-serif text-4xl font-light tracking-[-0.03em] text-white sm:text-5xl">Une application de rencontre pensée pour toute la communauté LGBTQ+.</h1>
          <p className="mt-6 text-lg leading-relaxed text-white/50">Embir est une application inclusive pour les rencontres LGBTQ+ : gay, lesbienne, bi, trans, queer. Profils vérifiés, filtres d'orientation, zéro pub.</p>
