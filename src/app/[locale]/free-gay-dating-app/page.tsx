...
export const metadata: Metadata = {
  ...
  description: "Embir is a free gay dating app with verified profiles, smart AI matching, and no ads. Unlimited messaging, zero subscriptions during launch.",
alternates: {
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-white/50">Embir is a free gay dating app with verified profiles, smart AI matching, and no ads. Unlimited messaging, zero subscriptions during launch.</p>
