...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  const descriptions: Record<string, string> = {
    en: "Zurich dating app: verified profiles, compatibility matching, and a founding community across Kreis 4, Seefeld, Niederdorf, and beyond. core connection features are free. Bilingual EN/FR.",
    fr: "Application de rencontre à Zurich : profils vérifiés, matching par compatibilité, communauté fondatrice. gratuite pour les connexions essentielles. Bilingue FR/EN.",
  };
  return {
        ...
        <section className="mt-12 space-y-5 text-base leading-relaxed text-white/55">
          ...
          <div>
            ...
            <div className="mt-4 space-y-3">
              {[
                ...
                ["Founding members, not Swiss banking hype", "We&apos;re not going to fabricate Zurich member counts. The founding community starts small. Selfie verification is available and approved profiles display a badge. Every member matters. Quality over quantity — Swiss precision applied to dating."],
              ].map(([title, text]) => (
          ...
          <div>
            ...
            <div className="mt-6 space-y-3">
              {[
                ["How many members does Embir have in Zurich?", "Embir is in its core connection experience. We&apos;re building the Zurich founding community right now — starting with a core of verified members. We don&apos;t publish inflated numbers. The community grows through invitations and word of mouth across Zurich&apos;s districts."],
