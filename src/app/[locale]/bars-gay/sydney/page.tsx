...
export const metadata: Metadata = {
  title: "Meilleurs Bars Gay Sydney — Top Adresses 2026 | Embir",
  description: "Guide complet des meilleurs bars gay à Sydney. Boîtes de nuit, bars branchés, lieux de rencontre où sortir ce soir.",
  keywords: ["bars gay sydney", "soirée gay sydney", "sydney vie nocturne gay"],
  alternates: { canonical: "https://embir.xyz/bars-gay/sydney" },
};

export default function GayBarsPage() {
  const bars = "The Imperial Hotel, Oxford Hotel, Stonewall Hotel".split(", ");
  const hoods = "Darlinghurst, Newtown, Surry Hills".split(", ");
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-black mb-6">
            ...
            <span className="bg-gradient-to-r from-rose-300 via-amber-300 to-purple-300 bg-clip-text text-transparent">Sydney</span>
          </h1>
          
          <p className="text-white/50 text-lg mb-8 leading-relaxed">
            Tu cherches les meilleurs bars et boîtes gay à Sydney ? Voici notre guide complet pour sortir
          ...
          <div className="grid gap-4 sm:grid-cols-3 mb-10">
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-center">
              ...
              <div className="text-white font-bold">The Imperial Hotel</div>
              <div className="text-white/40 text-sm mt-1">Bar recommandé #1</div>
            </div>
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-center">
              <div className="text-3xl mb-2">📍</div>
              <div className="text-white font-bold">Darlinghurst</div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 sm:p-8 mb-10">
            <h2 className="text-xl font-bold text-white mb-4">Top bars et boîtes gay à Sydney</h2>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 sm:p-8 mb-10">
            <h2 className="text-xl font-bold text-white mb-4">Quartiers gay-friendly à Sydney</h2>
