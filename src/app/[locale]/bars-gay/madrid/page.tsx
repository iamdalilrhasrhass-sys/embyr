...
export const metadata: Metadata = {
  title: "Best Gay Bars in Madrid — Guide & Map | Embir",
  description: "Discover the best gay bars in Madrid with Embir's curated guide. Find LGBTQ-friendly spots, meet locals, and explore the scene.",
  keywords: ["gay bars Madrid", "LGBTQ bars Madrid", "gay nightlife Madrid", "gay scene Madrid"],
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-black mb-6 text-white">
            Best gay bars in <span className="text-white/70">Madrid</span>
          </h1>
          <p className="text-white/50 text-lg mb-8 leading-relaxed">
            Explore Madrid&apos;s LGBTQ nightlife. From cozy neighborhood pubs to vibrant dance clubs, 
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 text-center mb-10">
            <h2 className="text-2xl font-bold text-white mb-3">Meet guys who love Madrid&apos;s nightlife</h2>
          ...
          <div className="prose prose-invert max-w-none text-white/50 space-y-4">
            <h2 className="text-white text-xl font-bold">Navigating the gay scene in Madrid</h2>
            <p>
              Madrid has a rich LGBTQ nightlife. Whether you&apos;re into relaxed wine bars, 
