...
export const metadata: Metadata = {
  title: "Meilleurs Bars Gay Barcelone — Top Adresses 2026 | Embyr",
  description: "Guide complet des meilleurs bars gay à Barcelone. Boîtes de nuit, bars branchés, lieux de rencontre où sortir ce soir.",
  keywords: ["bars gay barcelone", "soirée gay barcelone", "barcelone vie nocturne gay"],
  alternates: { canonical: "https://embir.xyz/bars-gay/barcelona" },
};

export default function GayBarsPage() {
  const bars = "Arena Drag, Metro Disco, La Chapelle, Punto BCN, Átame".split(", ");
  const hoods = "Gaixample, El Raval, Born, Barceloneta".split(", ");
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-black mb-6">
            ...
            <span className="bg-gradient-to-r from-rose-300 via-amber-300 to-purple-300 bg-clip-text text-transparent">Barcelone</span>
          </h1>
          
          <p className="text-white/50 text-lg mb-8 leading-relaxed">
            Tu cherches les meilleurs bars et boîtes gay à Barcelone ? Voici notre guide complet pour sortir
          ...
          <div className="grid gap-4 sm:grid-cols-3 mb-10">
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-center">
              ...
              <div className="text-white font-bold">Arena Drag</div>
              <div className="text-white/40 text-sm mt-1">Bar recommandé #1</div>
            </div>
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-center">
              <div className="text-3xl mb-2">📍</div>
              <div className="text-white font-bold">Gaixample</div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 sm:p-8 mb-10">
            <h2 className="text-xl font-bold text-white mb-4">Top bars et boîtes gay à Barcelone</h2>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 sm:p-8 mb-10">
            <h2 className="text-xl font-bold text-white mb-4">Quartiers gay-friendly à Barcelone</h2>
