...
export const metadata: Metadata = {
  title: "Gay Dating Site — 100% Free, No Ads | Embir",
  description: "The best gay dating site. 100% free, no ads, 25 languages.",
    ...
    <main className="emb-page min-h-screen">
      <section className="py-24 px-4 sm:px-6">
        <div className="emb-container max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-black mb-6 text-white">The Best Gay Dating Site</h1>
          <p className="text-white/50 text-lg mb-8 leading-relaxed">The best gay dating site. 100% free, no ads, 25 languages.</p>
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 text-center mb-10">
            ...
            <p className="text-white/50 mb-6">Join Embir now. 100% free, no ads, no catch.</p>
          ...
          <div className="prose prose-invert max-w-none text-white/50 space-y-4">
            ...
            <p>Unlike other gay dating sites, Embir is 100% free. Unlimited messaging, full profiles, discover guys near you — everything included, no exceptions.</p>
