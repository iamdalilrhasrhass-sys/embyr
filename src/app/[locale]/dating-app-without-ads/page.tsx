...
export const metadata: Metadata = {
  ...
  description: "Tired of ads between every swipe? Embir is a dating app with absolutely no ads. Premium experience, free for core connections.",
alternates: {
      ...
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-embir-rose/20 bg-embir-rose/5 px-4 py-1.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-embir-rose/80">No Ads</span>
          </div>
          ...
          <p className="mt-6 text-lg leading-relaxed text-white/50">Tired of ads between every swipe? Embir is a dating app with absolutely no ads. Premium experience, free for core connections.</p>
