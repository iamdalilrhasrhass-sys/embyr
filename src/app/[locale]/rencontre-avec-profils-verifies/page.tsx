...
export const metadata: Metadata = {
  title: "Application de rencontre avec profils vérifiés — zéro faux profil",
  description: "Embir vérifie chaque profil par selfie. Rencontres authentiques garanties. Gratuit au lancement.",
    ...
    <main className="emb-page min-h-screen">
      <section className="px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 text-lg text-white/50">Embir vérifie chaque profil par selfie. Rencontres authentiques garanties. Gratuit au lancement.</p>
