      ...
      <section className="relative px-4 pt-32 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#d4a574]/20 bg-[#d4a574]/5 px-4 py-1.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[#d4a574]/80">France</span>
          </div>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <TrackedLink href="/auth/register?source=fr-landing" label="Créer mon profil gratuit" location="fr-landing-hero" className="inline-flex items-center gap-2 rounded-full bg-[#d4a574] px-8 py-4 text-sm font-bold text-[#0a0614] transition-all hover:bg-[#e8c4a2] hover:shadow-[0_0_40px_rgba(212,165,116,0.3)]">
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8 bg-white/[0.01]">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="mt-4 text-center font-serif text-3xl font-light tracking-[-0.02em] text-white sm:text-4xl">
            ...
            <span className="text-[#d4a574]">dans toute la France.</span>
          </h2>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-serif text-3xl font-light tracking-[-0.02em] text-white sm:text-4xl">
            ...
            <span className="text-[#d4a574]">Gratuit, vérifié, sans pub.</span>
          </h2>
      ...
      <section className="px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/blog/meilleures-applis-rencontre-gay-france" className="text-sm text-white/35 hover:text-[#d4a574] transition-colors underline underline-offset-4">Meilleures applis rencontre gay</Link>
            <span className="text-white/10">·</span>
            <Link href="/blog/alternative-grindr-gratuite" className="text-sm text-white/35 hover:text-[#d4a574] transition-colors underline underline-offset-4">Alternative à Grindr gratuite</Link>
            <span className="text-white/10">·</span>
            <Link href="/paris" className="text-sm text-white/35 hover:text-[#d4a574] transition-colors underline underline-offset-4">Rencontre gay Paris</Link>
            <span className="text-white/10">·</span>
            <Link href="/grindr-vs-alternatives" className="text-sm text-white/35 hover:text-[#d4a574] transition-colors underline underline-offset-4">Comparatif Grindr vs alternatives</Link>
            <span className="text-white/10">·</span>
            <Link href="/" className="text-sm text-white/35 hover:text-[#d4a574] transition-colors underline underline-offset-4">Accueil Embir</Link>
          </div>
        </div>
      </section>
    </main>
