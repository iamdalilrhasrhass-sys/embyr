  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-10">
      ...
      <div className="mb-6 flex flex-wrap gap-3">
        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold bg-green-500/10 text-green-400 border border-green-500/20">
          <span className="w-1.5 h-1.5 bg-green-400 rounded-full animate-pulse" />
          🎁 Accès lancement gratuit activé
        </span>
      ...
      {/* Progression profil */}
      {completion < 100 && (
        <div className="mb-8 p-5 rounded-2xl border border-cyan-500/10 bg-cyan-500/[0.03] backdrop-blur-sm">
          ...
          <div className="w-full h-2 rounded-full bg-white/[0.06] overflow-hidden">
            <div className="h-full rounded-full transition-all duration-500"
              style={{ width: `${completion}%`, background: "linear-gradient(90deg, #06B6D4, #6366F1)" }} />
          </div>
          <Link href="/dashboard/profile" className="inline-block mt-3 text-xs text-cyan-400 hover:text-cyan-300 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <Link href="/dashboard/profile" className="group p-6 rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm hover:bg-white/[0.04] hover:border-white/[0.12] transition-all duration-300">
          ...
          <span className="inline-block mt-3 text-xs text-cyan-400 group-hover:translate-x-1 transition-transform">
        ...
        <Link href="/messages" className="group p-6 rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm hover:bg-white/[0.04] hover:border-white/[0.12] transition-all duration-300">
          ...
          <span className="inline-block mt-3 text-xs text-cyan-400 group-hover:translate-x-1 transition-transform">Voir →</span>
        </Link>
        ...
        <Link href="/membres" className="group p-6 rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm hover:bg-white/[0.04] hover:border-white/[0.12] transition-all duration-300">
          ...
          <span className="inline-block mt-3 text-xs text-cyan-400 group-hover:translate-x-1 transition-transform">Explorer →</span>
        </Link>
        ...
        <Link href="/premium" className="group p-6 rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm hover:bg-white/[0.04] hover:border-white/[0.12] transition-all duration-300 md:col-span-3 lg:col-span-1">
          ...
          <span className="inline-block mt-3 text-xs text-purple-400 group-hover:translate-x-1 transition-transform">Découvrir →</span>
        </Link>
      </div>
      ...
      <div className="rounded-2xl border border-white/[0.06] bg-white/[0.01] p-6 md:p-8 mb-8">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-white/40 text-sm">
              Embyr est gratuit pendant le lancement. Partage le lien avec
              quelques personnes pour agrandir la communauté.
            </p>
          </div>
          <div className="flex gap-3">
            <button
              onClick={() => { navigator.clipboard.writeText("Je viens de rejoindre Embyr, une nouvelle plateforme de rencontre moderne et gratuite pendant son lancement. Tu peux créer ton profil ici : https://embir.xyz"); }}
