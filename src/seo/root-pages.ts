...
const frProductPages = [
  ["application-rencontre-gratuite", "Application de rencontre gratuite", "Application de rencontre gratuite pour les connexions essentielles, immersive et authentique", "Cette page clarifie l'accès essentiel gratuit d'Embir tout en mettant l'accent sur les univers personnels, la compatibilite profonde et les profils verifies.", "Tout ce qu’il faut pour rencontrer quelqu’un est gratuit. Sans carte bancaire. Le profil, la sélection compatible, la réciprocité, les messages et les outils de sécurité forment un parcours accessible. Les services supplémentaires éventuels restent facultatifs et peuvent financer l'infrastructure, la modération et l'amélioration du produit."],
...
const frFreemiumPages = [
  ["gratuit-au-lancement", "gratuit pour les connexions essentielles", "Application de rencontre gratuite pour les connexions essentielles, pour toutes les orientations"],
  ...
  h1: h1Override ?? topic,
  topic,
  description: `${topic} sur Embir : tout ce qu’il faut pour rencontrer quelqu’un est gratuit, sans carte bancaire, avec des services facultatifs clairement séparés.`,
  angle: `Cette page detaille le modele ${topic.toLowerCase()} avec une promesse claire : gratuit pour les connexions essentielles, services facultatifs transparents et aucun piège d'abonnement sur le chemin vers une rencontre.`,
  priority: 0.88,
}));
...
const enFreemiumPages = [
  ...
  h1: topic,
  topic,
  description: `${topic} on Embir: everything needed to meet someone is free without a credit card, with optional services clearly separated.`,
  angle: `This page explains ${topic.toLowerCase()} through a clear contract: the path to a reciprocal meeting works without a credit card.`,
  priority: 0.88,
}));
...
const enProductPages = [
  ...
  ["best-free-dating-app", "Best free dating app", "The best free dating app for real connections worldwide", "Embir combines reciprocal preferences, compatibility and safety without placing a payment step in the path to a meeting.", "Everything needed to meet someone is free. No credit card required: profile, compatible discovery, reciprocity, messaging and safety tools."],
