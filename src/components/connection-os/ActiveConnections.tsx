...
export function ActiveConnections({
  ...
  return (
    <section
      ...
      aria-busy={loading}
      className="rounded-[2rem] border border-embir-rose/15 bg-embir-rose/[0.025] p-5 sm:p-7"
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="max-w-2xl">
          <p className="mb-2 text-[10px] font-bold uppercase tracking-[0.24em] text-embir-rose">
            {text.step}
          </p>
          <h2
      ...
      {loading ? (
        ...
        <div className="mt-6 rounded-2xl border border-dashed border-white/[0.09] p-7 text-center">
          <span aria-hidden="true" className="text-2xl text-embir-rose">
            ◇
          </span>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    aria-hidden="true"
                    className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-embir-rose/20 to-embir-rose/20 font-serif text-white/80"
                  >
                ...
                <Link
                  ...
                  className="mt-4 inline-flex w-full items-center justify-center rounded-xl border border-embir-rose/20 bg-embir-rose/[0.06] px-3 py-2.5 text-center text-xs font-semibold text-embir-blush transition hover:bg-embir-rose/10"
                >
                  {nextLabel}
                </Link>
              </article>
