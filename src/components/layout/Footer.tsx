        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[var(--color-premium-gray)]">
              <li><Link href="/" className="hover:text-[#ff5e36]">Accueil</Link></li>
              <li><Link href="/paris" className="hover:text-[#ff5e36]">100 fondateurs Paris</Link></li>
              <li><Link href="/about" className="hover:text-[#ff5e36]">À propos</Link></li>
              <li><Link href="/membres" className="hover:text-[#ff5e36]">Membres</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[var(--color-premium-gray)]">
              <li><Link href="/legal/cgu" className="hover:text-[#ff5e36]">Conditions Générales</Link></li>
              <li><Link href="/legal/confidentialite" className="hover:text-[#ff5e36]">Confidentialité</Link></li>
              <li><Link href="/legal/18-plus" className="hover:text-[#ff5e36]">Vérification d&apos;âge</Link></li>
              <li><Link href="/legal/moderation" className="hover:text-[#ff5e36]">Modération & Signalement</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-[var(--color-premium-gray)]">
              ...
              <li><Link href="/faq" className="hover:text-[#ff5e36]">Foire Aux Questions</Link></li>
            </ul>
          </div>
        </div>
