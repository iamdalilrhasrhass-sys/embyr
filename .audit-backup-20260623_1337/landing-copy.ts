...
const fr: CopySet = {
  ...
  hero_subtitle:
    "Embir est la seule application qui filtre strictement par orientation. Un hétéro ne verra jamais un profil gay. Un gay ne verra que des gays — sauf si tu choisis autrement. Amour, amis, fun, sport, événements : tu trouves exactement ce que tu cherches.",
  ...
  orient_cards: [
    ...
    { icon: "⚥", title: "Bi / Queer / Pan", body: "Tu es fluide. Tu choisis exactement qui tu veux voir." },
  ],
  ...
  proof_stats: [
    ...
    { value: "10×", label: "Plus de connexions si vérifié" },
    { value: "0", label: "Publicité, zéro tracking" },
    { value: "24", label: "Langues supportées" },
  ],
...
const en: CopySet = {
  ...
  hero_subtitle:
    "Embir is the only dating app that filters strictly by orientation. A straight person never sees a gay profile. A gay person only sees gay profiles — unless you choose otherwise. Love, friends, fun, sports, events: find exactly what you're looking for.",
  ...
  orient_cards: [
    { icon: "⚤", title: "Straight", body: "You're looking for the opposite sex. You only see those profiles." },
    { icon: "⚣", title: "Gay", body: "You're looking for a man. You only see men looking for you." },
    { icon: "⚢", title: "Lesbian", body: "You're looking for a woman. You only see women looking for you." },
    { icon: "⚥", title: "Bi / Queer / Pan", body: "You're fluid. You choose exactly who you want to see." },
  ],
  ...
  proof_stats: [
    ...
    { value: "10×", label: "More connections if verified" },
...
const es: CopySet = {
  ...
  hero_subtitle:
    "Embir es la única aplicación que filtra estrictamente por orientación. Una persona heterosexual nunca ve un perfil gay. Una persona gay solo ve perfiles gays, a menos que elijas lo contrario. Amor, amigos, diversión, deportes, eventos: encuentra exactamente lo que buscas.",
  ...
  orient_cards: [
    ...
    { icon: "⚣", title: "Gay", body: "Buscas un hombre. Solo ves hombres que te buscan." },
    { icon: "⚢", title: "Lesbiana", body: "Buscas una mujer. Solo ves mujeres que te buscan." },
    { icon: "⚥", title: "Bi / Queer / Pan", body: "Eres fluido. Eliges exactamente a quién quieres ver." },
  ],
  ...
  proof_stats: [
    ...
    { value: "10×", label: "Más conexiones si verificado" },
    { value: "0", label: "Anuncios, cero tracking" },
    { value: "24", label: "Idiomas soportados" },
  ],
