...
### Images (required)
- Logo: 240×240 PNG (use /public/og-image.png cropped)
- Screenshots: 1270×760 (4-6 recommended)
...
## Maker Story (for PH profile)

Hey Product Hunt! 👋

I'm Dalil, the maker behind EMBIR.
...
I'd love your feedback, questions, or feature requests. AMA in the comments!
...
Thanks for checking out EMBIR! A few things I want to be transparent about:
...
4. **Open source:** github.com/embir — the entire codebase is public. Audit us. Fork us. Contribute.

What would YOU want to see in a dating app that actually respects you?

---

## Launch Checklist

- [ ] Create upcoming page at producthunt.com/upcoming
- [ ] Upload logo (240×240)
- [ ] Upload 4-6 screenshots (1270×760)
- [ ] Set launch date (Tuesday-Thursday, 12:01 AM PST for max exposure)
- [ ] Prepare Maker Story (above)
- [ ] Prepare First Comment (above)
- [ ] Line up 5-10 friends for early upvotes
- [ ] Cross-post launch to Dev.to, Reddit (r/SideProject, r/gay, r/LGBT)
- [ ] Tweet thread ready for launch day
- [ ] Email list / social media blast scheduled

---

## Competitor Comparison (for PH description)

| Feature | EMBIR | Grindr | Tinder | Scruff | Romeo |
|---------|-------|--------|--------|--------|-------|
| Free messaging | ✅ | ❌ (limited) | ❌ (limited) | ❌ (limited) | ✅ |
| No ads | ✅ | ❌ | ❌ | ❌ | ❌ |
